...
/****** Object:  StoredProcedure [dbo].[FuncionesJsComplemento]    Script Date: 01/11/2016 15:49:09 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	-- Cambios en textos para callcenter, solo aplica si el formulario tiene nombre de callcenter 
		...
		IF((select 1 from formulario where idformulario=@idformulario and nombre like '%Callcenter%')=1)
			...
			--*************funcion del acreditado case*********-
			--DECLARE @funcAcreditado NVARCHAR(4000) ='switch (arrValores["Acreditado".toUpperCase()]) {case "Si/Encargado de Pagos":if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("CalificaProrroga", "Si", "==")) && (ValC("AceptaProrroga", "No", "=="))) {Mostrar("ROA", true);} else if ((ValC("CalificaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("CalificaProrroga", "Si", "==")) && (ValC("AceptaProrroga", "No", "=="))) {Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("CalificaProrroga", "No", "=="))) {Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("CalificaProrroga", "No", "=="))) { Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "Si", "=="))) {Mostrar("PromesaPago", false);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "=="))) {Mostrar("PromesaPago", true);}else if (ValC("CalificaFPP", "No", "==")) {Mostrar("PromesaPago", true);} else if ((ValC("CalificaFPP", "Si", "=="))) {Mostrar("PromesaPago", false);} break;case "No":{Mostrar("ROA", false);}break;case "Hostil":{Mostrar("ROA", false);}break;}'
			DECLARE @funcAcreditado NVARCHAR(4000) ='switch (arrValores["Acreditado".toUpperCase()]) {case "Si/Encargado de Pagos":if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("DicCalificaProrroga", "Si", "==")) && (ValC("AceptaProrroga", "No", "=="))) {Mostrar("ROA", true);} else if ((ValC("CalificaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("DicCalificaProrroga", "Si", "==")) && (ValC("AceptaProrroga", "No", "=="))) {Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("DicCalificaProrroga", "No", "=="))) {Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "No", "==")) && (ValC("PromesaPago", "No", "==")) && (ValC("DicCalificaProrroga", "No", "=="))) { Mostrar("ROA", true);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "Si", "=="))) {Mostrar("PromesaPago", false);}else if ((ValC("CalificaFPP", "Si", "==")) && (ValC("AceptaFPP", "No", "=="))) {Mostrar("PromesaPago", true);}else if (ValC("CalificaFPP", "No", "==")) {Mostrar("PromesaPago", true);} else if ((ValC("CalificaFPP", "Si", "=="))) {Mostrar("PromesaPago", false);} break;case "No":{Mostrar("ROA", false);Mostrar("PromesaPago", false);}break;case "Hostil":{Mostrar("ROA", false);Mostrar("PromesaPago", false);}break;}'	
			
			INSERT INTO [CatFuncionesJS]([Nombre],[Validacion],[FuncionSI],[FuncionNo],[idFormulario])
						values ('FuncAcreditado',null
						,@funcAcreditado
						,null,@idFormulario)
			SELECT @idFuncionJs = SCOPE_IDENTITY()
			
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='Acreditado' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='CalificaFPP' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='PromesaPago' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='AceptaFPP' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='DicCalificaProrroga' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='AceptaProrroga' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			
			--*************funcion del acreditado PromesaPago*********-
			DECLARE @funcPromesaPago NVARCHAR(4000) ='switch (arrValores["PromesaPago".toUpperCase()]){case "Ya realizó el pago":{Mostrar("ROA",false);}break;case "Si":{Mostrar("ROA",false);}break;}'
			
			
			INSERT INTO [CatFuncionesJS]([Nombre],[Validacion],[FuncionSI],[FuncionNo],[idFormulario])
						values ('FuncPromesaPago',null
						,@funcPromesaPago
						,null,@idFormulario)
			SELECT @idFuncionJs = SCOPE_IDENTITY()
			
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario)  
			SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='PromesaPago' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 
			
		
		--*************funcion del acreditado PromesaPago*********-
			DECLARE @funcAceptaProrroga NVARCHAR(4000) ='if(ValC("AceptaProrroga", "Si","==")){Mostrar("ROA",false);}'
	
			
			INSERT INTO [CatFuncionesJS]([Nombre],[Validacion],[FuncionSI],[FuncionNo],[idFormulario])
						values ('FuncAceptaProrroga',null
						,@funcAceptaProrroga
						,null,@idFormulario)
			SELECT @idFuncionJs = SCOPE_IDENTITY()
			
			INSERT  INTO [dbo].[FuncionesXCampos] (idFuncionJS,idCampoFormulario) 
			SELECT @idFuncionJs,idCampoFormulario from CamposXSubFormulario where NombreCampo='AceptaProrroga' and idSubFormulario in (select idSubFormulario from SubFormulario where idFormulario=@idformulario) 			
			...
			update camposxsubformulario set ClasesLinea=ClasesLinea+' CWVariables', ClasesValor=ClasesValor + ' CWVariables' where nombrecampo in (
				...
				-- Se actualiza el valor del campo para limpiarlo
				update camposxsubformulario set  valor='' where nombrecampo='CaptureNumFolioPago' and idSubFormulario in (select idsubformulario from subformulario where idformulario=@idFormulario)

				-- Modificaciones para obtener datos relevantes en el formulario e inicializar el arreglo de datos
				update camposxsubformulario set  Valor='[Tabla]DicAplicaFPP',idTipoCampo='2' where nombrecampo='CalificaFPP' and idSubFormulario in (select idsubformulario from subformulario where idformulario=@idFormulario) and idTipoCampo=1
				update camposxsubformulario set  Valor='[Tabla]DicCalificaProrroga', idTipoCampo='2' where nombrecampo='DicCalificaProrroga' and idSubFormulario in (select idsubformulario from subformulario where idformulario=@idFormulario) and idTipoCampo=1
