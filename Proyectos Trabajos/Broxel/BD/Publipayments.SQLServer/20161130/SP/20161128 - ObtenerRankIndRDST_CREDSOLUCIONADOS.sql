/****** Object:  StoredProcedure [dbo].[ObtenerRankIndRDST_CREDSOLUCIONADOS]    Script Date: 28/11/2016 01:02:59 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[ObtenerRankIndRDST_CREDSOLUCIONADOS] 
		...
		BEGIN
			...
			LEFT JOIN (
				...
				AND o.idDictamen IN (
					...
					WHERE Nombre IN ('DictamenFPP', 'DictamenPromesaPago','DictamenPPFPP','DictamenLiquidacion','DictamenCONFPRParcial','DictamenProrrogaP')  
