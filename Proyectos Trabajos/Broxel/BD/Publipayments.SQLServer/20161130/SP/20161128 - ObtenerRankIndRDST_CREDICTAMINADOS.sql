/****** Object:  StoredProcedure [dbo].[ObtenerRankIndRDST_CREDICTAMINADOS]    Script Date: 28/11/2016 01:07:37 p. m. ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Calcula tabla de valores para indicador CREDITOS DICTAMINADOS
-- =============================================
ALTER PROCEDURE [dbo].[ObtenerRankIndRDST_CREDICTAMINADOS] 
		...
		BEGIN
			...
			LEFT JOIN (
				...
				AND o.idDictamen IN (
					...
					WHERE Nombre NOT IN ('DictamenFPP', 'DictamenPromesaPago', 'DictamenPPFPP', 'DictamenLiquidacion', 'DictamenCONFPRParcial', 'DictamenProrrogaP')
