...
-- Description:	Calcula tabla de valores para indicador CREDITOS GESTIONADOS
-- =============================================
CREATE PROCEDURE [dbo].[ObtenerRankIndRDST_CREDGEST] 
	...
	BEGIN
		...
		BEGIN
			...
			LEFT JOIN (
				...
				LEFT JOIN Ordenes o WITH (NOLOCK) ON c.CV_CREDITO = o.num_Cred
				WHERE (o.Estatus IN (3, 4) OR o.idVisita > 1)
					AND o.idUsuario <> 0
