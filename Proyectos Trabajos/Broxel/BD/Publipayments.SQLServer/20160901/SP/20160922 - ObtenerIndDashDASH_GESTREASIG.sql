...
BEGIN	
	...
	where o.Estatus=3 AND  o.cvRuta=@ruta  and o.idUsuario<>0 and o.idDominio>1
	...
	AND o.idDictamen IN (
		SELECT idCatalogo FROM CatDictamen WHERE
	Nombre IN ('DictamenNopueaten','DictamenAcreditadoNoDisponible','Dictamentercvissincont','Dictamenavisoretencion','DictamenRecado','DictamenVisSContactoIDV2','DictamenVAdicIV2','DictamenIDV2AcNoDisponible')  
	) 
