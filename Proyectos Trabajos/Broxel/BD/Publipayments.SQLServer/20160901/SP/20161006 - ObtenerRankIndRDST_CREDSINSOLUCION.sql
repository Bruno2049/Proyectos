...
-- Description:	Calcula tabla de valores para indicador CREDITOS SIN SOLUCION
-- =============================================
CREATE PROCEDURE [dbo].[ObtenerRankIndRDST_CREDSINSOLUCION] 
	...
	BEGIN
		...
		BEGIN
			...
			LEFT JOIN (
				...
				LEFT JOIN Ordenes o WITH (NOLOCK) ON c.CV_CREDITO = o.num_Cred AND c.CV_RUTA = O.CVRUTA
				WHERE c.CV_RUTA = @TipoFormulario
				AND (o.Estatus IS NULL OR o.Estatus IN (1, 11, 12, 15))
