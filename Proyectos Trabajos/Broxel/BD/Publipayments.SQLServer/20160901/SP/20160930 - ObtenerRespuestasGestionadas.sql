...
* Modifico:				Laura Dotor
* Modificacion:			Se agregan condiciones para mandar reporte de Cedula Inspección, se cambio el tipo de archivo
* Tipo 1: Gestiones, Tipo 2: GestionesP, Tipo 3: CedulaInspeccion
**********************************************************************/
...
BEGIN
	...
	DECLARE @campos NVARCHAR(max),
		...
		,@Fecha varchar(10) = CONVERT(VARCHAR(10), CAST(getdate() -2 AS DATETIME), 121)
	...
	SET @RutasNa = CASE @tipoArchivo WHEN 1 THEN '''vsmp'',''RA'',''CI''' WHEN 2 THEN '''VBD'',''CSD'',''RDST'',''RA'',''CI''' WHEN 3 THEN '''VBD'',''CSD'',''RDST'',''RA'',''vsmp''' END
