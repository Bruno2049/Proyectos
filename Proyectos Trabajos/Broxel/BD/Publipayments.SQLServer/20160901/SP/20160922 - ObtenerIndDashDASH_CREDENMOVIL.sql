...
-- =============================================
ALTER PROCEDURE [dbo].[ObtenerIndDashDASH_CREDENMOVIL]
	@idUsuario  int,
...
SELECT @parte=fi_Parte,@nombreDisplay=fc_Descripcion FROM dbo.Utils_Descripciones with (nolock) WHERE fc_Clave = 'DASH_CREDENMOVIL' 
...
BEGIN
	...
	where o.Estatus in(1,11,12,15,6) and
	o.[CvRuta]=@ruta AND o.idUsuario<>0 
