...
AS
BEGIN
	 select a.num_Cred,a.idOrden,a.Telefono,a.Clave,rr.Valor as Dictamen from (select r.idOrden,r.idDominio,r.idUsuarioPadre,r.Valor from respuestas r WITH (NOLOCK) inner join camposrespuesta cr WITH (NOLOCK)
