...
/****** Object:  Index [IX_AutorizacionSMS]    Script Date: 26/02/2015 10:15:51 a. m. ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_AutorizacionSMS] ON [dbo].[AutorizacionSMS]
(
	[Telefono] ASC
)  INCLUDE (id, Clave, idOrden)
GO
