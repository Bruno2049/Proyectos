...
namespace PubliPayments.Reportes.ReporteGestionMovil
{
    public partial class GestionXHora : XtraReport
    {
        ...
        public GestionXHora(string delegacion = "", string fechaCarga = "", string resFinal = "", string diaGestion = "", string despacho = "", string supervisor = "", string tipoFormulario="")
        {
            InitializeComponent();
        ...
        public XRTable CreateXrTable() {
            ...
            var tablaValoresBd = TablaDatosMaster(_delegacion, _fechaCarga, _resFinal, _diaGestion, _tipoFormulario);
        ...
        {
            var table = new XRTable { Borders = BorderSide.All };
            var tablaValoresBd = TablaDatosSupervisor(_delegacion, _fechaCarga, _resFinal, _diaGestion, despacho, _tipoFormulario);
            if (tablaValoresBd.Columns.Count > 20)
            {
                var tamanioAnterior = (PageWidth - Margins.Left - Margins.Right);
                Landscape = true;
        ...
        {
            var table = new XRTable { Borders = BorderSide.All };
            var tablaValoresBd = TablaDatosGestor(_delegacion, _fechaCarga, _resFinal, _diaGestion, despacho, supervisor, _tipoFormulario);
            if (tablaValoresBd.Columns.Count > 20)
            {
                var tamanioAnterior = (PageWidth - Margins.Left - Margins.Right);
                Landscape = true;
        ...
        private void GestionXHora_BeforePrint(object sender, PrintEventArgs e)
        {
            if (_supervisor != "" && _despacho != "")
            {
        ...
        DataTable TablaDatosMaster(string delegacion = "", string fechaCarga = "", string resFinal = "", string diaGestion = "", string tipoFormulario="")
        {
        ...
        DataTable TablaDatosSupervisor(string delegacion = "", string fechaCarga = "", string resFinal = "", string diaGestion = "",string despacho="",string tipoFormulario="")
        {
        ...
        DataTable TablaDatosGestor(string delegacion = "", string fechaCarga = "", string resFinal = "", string diaGestion = "", string despacho = "", string supervisor = "", string tipoFormulario="")
        {
