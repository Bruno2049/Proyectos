...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "ServicioDW" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select ServicioDW.svc or ServicioDW.svc.cs at the Solution Explorer and start debugging.
    public class ServicioDW : IServicio
    {
        private const int ServExt = 2;
