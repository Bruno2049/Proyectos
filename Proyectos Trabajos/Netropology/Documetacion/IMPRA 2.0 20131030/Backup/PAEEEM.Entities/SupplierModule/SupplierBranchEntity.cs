...
{
    public class SupplierBranchModel
    {
        ...
        private object _dt_fecha_branch;
        public object Dt_Fecha_Branch
        {
            get { return this._dt_fecha_branch; }
            set 
            {
                if (DBNull.Value == value)
                {
                    this._dt_fecha_branch = null;
                }
                else
                {
                    this._dt_fecha_branch = value;
                }
            }
        }
        ...
        private string _codigo_Branch;
        public string Codigo_Branch
        {
            get { return _codigo_Branch; }
            set { this._codigo_Branch = value; }
        }
    }
}
