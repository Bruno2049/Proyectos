...
namespace PAEEEM.BussinessLayer
{
    public class K_CREDITOBll
    {
      ...
      //                  savingEconomicConsumption = Calculator(keys, values, averageConsumption - energyConsumptionSavings);
        ...
        /// <returns></returns>
        public int Insert_K_CreditoData(CreditEntity Credit, K_CREDITO_COSTOEntity Cost, K_CREDITO_DESCUENTOEntity Descuento, List<K_CREDITO_PRODUCTOEntity> Product, ScheduleJobEntity ScheduleEntity, CAT_AUXILIAREntity Cat_Auxiliar, string PeriodEndDate)
        {
            int Count = 0;
            //int returnTemp = 0;
            try
        ...
        /// <param name="Credit"></param>
        /// <returns></returns>
        public int Insert_K_CreditPage1Data(CreditEntity Credit,CAT_AUXILIAREntity Cat_Auxilira)
        {
            int Result = 0;
            try
            {
        ...
        /// <returns></returns>
        public int Update_CreditReview(CreditEntity credit, List<K_CREDITO_PRODUCTOEntity> lsitCreditProduct, DataTable CreditAutDt,CAT_AUXILIAREntity catAuxilira,K_CREDITO_COSTOEntity creCostEntity, K_CREDITO_DESCUENTOEntity creDestEntity)
        {
            int Iupdate = 0;
            try
            {
        ...
        /// <returns></returns>
        public int Update_CreditReviewExceptProduct(CreditEntity credit, CAT_AUXILIAREntity catAuxilira)
        {
            int Iupdate = 0;
            try
            {
