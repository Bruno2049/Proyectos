...
namespace PAEEEM
{
    public partial class ValidateCrediticialHistroy : System.Web.UI.Page
    {
...
//                            DisposalCenterDatatable = CAT_CENTRO_DISPBLL.ClassInstance.Get_CAT_CENTRO_DISPByTECHNOLOGY(0, Requested_Technology);
        ...
        private void LoadIntegrateDataFromUI(out CreditEntity creditomodel)
        {
            creditomodel = new CreditEntity();
