                ...
                <div>
                    <asp:GridView ID="grdReceivedOldEquipment" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="1" HeaderText="Gas" DataFormatString="{0:dd-MM-yyyy}" />
                            <asp:BoundField DataField="2" HeaderText="Aceite" DataFormatString="{0:dd-MM-yyyy}" />
                            <asp:BoundField DataField="3" HeaderText="Cobre" DataFormatString="{0:dd-MM-yyyy}" />
                            <asp:BoundField DataField="4" HeaderText="Aluminio" DataFormatString="{0:dd-MM-yyyy}" />
                            <asp:BoundField DataField="5" HeaderText="Fierro" DataFormatString="{0:dd-MM-yyyy}" />
                            <asp:BoundField DataField="6" HeaderText="Otros" DataFormatString="{0:dd-MM-yyyy}" />
