<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="PAEEEM.Login" %>
...
<form id="form1" runat="server" style="width: 100%; height: 100%">
    ...
    <table style="width: 100%; height:100%">
					<tr>
									<td align="center" style="width: 711px; background-image:url('../images/login.png'); background-position:center top; background-repeat:no-repeat; " >
									
                 <br />
									
                 <asp:Login ID="ctlLogin" runat="server" OnAuthenticate="ctlLogin_Authenticate" 
                 DisplayRememberMe="False" Width="312px" Height="180px" BorderPadding="0"
        ...
        <div id="divPassword" style="width: 350px">
