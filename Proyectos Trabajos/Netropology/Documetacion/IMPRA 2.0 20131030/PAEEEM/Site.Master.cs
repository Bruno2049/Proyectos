...
namespace PAEEEM
{
    public partial class Site : System.Web.UI.MasterPage
    {
        ...
        private void RenderLoadTree(int RoleID)
        {
            ...
            if (dtNavigationRoot != null && dtNavigationRoot.Rows.Count > 0)
            {
                ...
                if (RootNode != null)
                {
                    ...
                    LoadChildrenNodeToRoot(RootNode, RoleID);
                }
            }
        }
        /// <summary>
        ...
        private void LoadChildrenNodeToRoot(TreeNode RootNode, int RoleID)
        {
            ...
            if (dtNavigationRoot != null && dtNavigationRoot.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtNavigationRoot.Rows.Count; i++)
                {
                    ...
                    LoadChildrenNodeToRoot(ChildNode, RoleID);
                }
            }
        }
        /// <summary>
