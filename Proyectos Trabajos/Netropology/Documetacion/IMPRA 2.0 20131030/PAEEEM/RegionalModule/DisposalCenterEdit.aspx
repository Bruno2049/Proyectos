...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="container">
        <asp:UpdatePanel ID="panel1" runat="server">
            <ContentTemplate>
                ...
                <table width="100%">
					...
					<tr>
                        <td width="25%">
                            <asp:Label ID="lblDxApPaternoRepre" runat="server" Text="Apellido Paterno Responsable" CssClass="Label_2"></asp:Label></td><td>
							<asp:TextBox ID="txtDxApPaternoRepre" runat="server" CssClass="TextBox"></asp:TextBox>
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtDxApPaternoRepre" ErrorMessage="(*) Campo Obligatorio"
							ValidationGroup="Save" ID="txtDxApPaternoRepreRequired">
							</asp:RequiredFieldValidator>
						</td>
					</tr>
					<tr>
                        <td width="25%">
                            <asp:Label ID="lblDxApMaternoRepre" runat="server" Text="Apellido Materno Responsable" CssClass="Label_2"></asp:Label></td><td>
							<asp:TextBox ID="txtDxApMaternoRepre" runat="server" CssClass="TextBox"></asp:TextBox>
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtDxApMaternoRepre" ErrorMessage="(*) Campo Obligatorio"
							ValidationGroup="Save" ID="txtDxApMaternoRepreRequired">
							</asp:RequiredFieldValidator>
						</td>
					</tr>
					<tr>
                        <td width="25%">
                            <asp:Label ID="lblDxCelularRepre" runat="server" Text="Celular Responsable" CssClass="Label_2"></asp:Label></td><td>
							<asp:TextBox ID="txtDxCelularRepre" runat="server" CssClass="TextBox"></asp:TextBox>
							<asp:RequiredFieldValidator runat="server" ControlToValidate="txtDxCelularRepre" ErrorMessage="(*) Campo Obligatorio"
							ValidationGroup="Save" ID="txtDxCelularRepreRequired">
							</asp:RequiredFieldValidator>
						</td>
					</tr>
					<tr>
                        <td width="25%">
                            <asp:Label ID="Label17" runat="server" Text="E-mail del Responsable" CssClass="Label_2"></asp:Label></td><td>
                            <div>
								...
								<asp:RegularExpressionValidator runat="server" ValidationExpression="^(([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+([;.](([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+)*$"
                                    ControlToValidate="txtRepresentativeEmail" ErrorMessage="(*) Campo Obligatorio" ID="RegularExpressionValidator10">
								</asp:RegularExpressionValidator></div>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%">
                            <asp:Label ID="Label18" runat="server" Text="Teléfono" CssClass="Label_2"></asp:Label></td><td>
                            <div>
								...
								<asp:RegularExpressionValidator runat="server" ValidationExpression="^((\d{10}))$"
                                    ControlToValidate="txtTelephone" ErrorMessage="(*) Campo Obligatorio" ID="RegularExpressionValidator12">
								</asp:RegularExpressionValidator>
                            </div>
                        </td>
                    </tr>
                    ...
                    <table width="100%">
                        <tr>                     
                        <td width="25%">
                            <asp:Label ID="Label19" runat="server" Text="Nombre del Representante Legal" CssClass="Label_2"></asp:Label></td><td>
                            <div>
                            </div>
					...
					<tr>
                        <td width="25%">
                            <asp:Label ID="lblDxApPaternoRepLeg" runat="server" Text="Apellido Paterno Representante Legal" CssClass="Label_2"></asp:Label></td><td>
                        ...
                        <td width="25%">
                            <asp:Label ID="lblDxApMaternoRepLeg" runat="server" Text="Apellido Materno Representante Legal" CssClass="Label_2"></asp:Label></td><td>
                        ...
                        <td width="25%">
                            <asp:Label ID="lblDxEmailRepreLegal" runat="server" Text="Email Representante Legal" CssClass="Label_2"></asp:Label></td><td>
                        ...
                        <td width="25%">
                            <asp:Label ID="lblDxTelefonoRepreLeg" runat="server" Text="Telefono Representante Legal" CssClass="Label_2"></asp:Label></td><td>
                        ...
                        <td width="25%">
                            <asp:Label ID="lblDxCelularRepreLeg" runat="server" Text="Celular Representante Legal" CssClass="Label_2"></asp:Label></td><td>
        ...
        <table width="100%">
            <tr>
                <td width="25%">
                    <asp:Label ID="Label20" runat="server" Text="Cargar Imagen Digital del Poder Notarial" CssClass="Label_2"></asp:Label></td><td>
                    <asp:FileUpload ID="fileUploadAttorneyPower" runat="server" Width="570px" />
                </td>
            </tr>
            <tr>
                <td width="25%">
                    <asp:Label ID="Label21" runat="server" Text="Cargar Imagen Digital del Acta Constitutiva" CssClass="Label_2"></asp:Label></td><td>
            ...
            <tr>
                <td width="25%">
                    <asp:Label ID="lblNoEmpleados" runat="server" Text="No Empleados" CssClass="Label_2"></asp:Label></td><td>
...
--%>        <table width="100%">
            <tr>
				...
				<tr>
                <td width="25%">
                    <asp:Label ID="lblMarcaAnalizadorGas" runat="server" Text="Marca Analizador Gas" CssClass="Label_2"></asp:Label></td><td>
                ...
                <td width="25%">
                    <asp:Label ID="lblModeloAnalizadorGas" runat="server" Text="Modelo Analizador Gas" CssClass="Label_2"></asp:Label></td><td>
                ...
                <td width="25%">
                    <asp:Label ID="lblSerieAnalizadorGas" runat="server" Text="Serie Analizador Gas" CssClass="Label_2"></asp:Label></td><td>
					...
					<tr>
                <td width="25%">
                    <asp:Label ID="lblNoRegistroAmbiental" runat="server" Text="No. Registro Ambiental" CssClass="Label_2"></asp:Label></td><td>
				...
				<tr>
                <td width="25%">
                    <asp:Label ID="lblTipo" runat="server" Text="Tipo" CssClass="Label_2"></asp:Label></td><td>
				...
				<tr>
                <td width="25%">
                    <asp:Label ID="lblHorarioDesde" runat="server" Text="Horario Desde" CssClass="Label_2" ToolTip="HH:MM:SS"></asp:Label></td><td>
                ...
                <td width="25%">
                    <asp:Label ID="lblHorarioHasta" runat="server" Text="Horario Hasta" CssClass="Label_2" ToolTip="HH:MM:SS"></asp:Label></td><td>
                ...
                <td width="25%">
                    <asp:Label ID="lblDiasSemana" runat="server" Text="Días Semana" CssClass="Label_2"></asp:Label></td><td>
                ...
                <td>&nbsp;
                    ...
                    <%--<tr>
						...
						<tr>
                        <td width="25%">
                            <asp:Label ID="lblTelefonoAtn1" runat="server" Text="Teléfono Atención 1" CssClass="Label_2"></asp:Label></td><td>
                        ...
                        <td width="25%">
                            <asp:Label ID="lblTelefonoAtn2" runat="server" Text="Teléfono Atención 2" CssClass="Label_2"></asp:Label></td><td>
            ...
            <tr>
                <td width="25%">
                    <asp:Label ID="Label26" runat="server" Text="Zona correspondiente" CssClass="Label_2"></asp:Label></td><td>
