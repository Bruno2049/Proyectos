<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="WebProyectoEquipos._Default" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <%--<%@ Register src="wuAltaBajaEquipos.ascx" tagname="wuAltaBajaEquipos" tagprefix="uc2" %>--%>        <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>        <%--<div style="width: 100%">                         
            <uc2:wuAltaBajaEquipos ID="wuAltaBajaEquipos1" runat="server" />  
        </div>--%>
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">
            <div id = "DivParseoTrama" runat="server" Visible="False">
            ...
            <div id = "Div1" runat="server">
                <fieldset id="Fieldset2" runat="server">
                    <legend>Validación Número de Servicio</legend>
                    <table style="width: 80%">
                        <tr>
                            <td>
                                <br/>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox ID="RadTxtServiceCode" runat="server">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadButton ID="RadBtnValidServiceCode" runat="server" 
                                    Text="Validar Código" onclick="RadBtnValidServiceCode_Click">
                                </telerik:RadButton>
                            </td>
                        </tr>
                    </table>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblSistema" runat="server" Text="Tarifa Destino:" Width="155px" 
                   ...
                   <telerik:RadGrid ID="rgEquiposAlta" runat="server" 
                        ...
                        OnItemCommand="rgEquiposAlta_ItemCommand">
                                ...
                                <MasterTableView DataKeyNames="ID" EditMode="InPlace" NoMasterRecordsText="No hay equipos de alta eficiencia"
                                    Width="100%" CommandItemDisplay="Top" AllowAutomaticUpdates="False">
                                    <CommandItemSettings ExportToPdfText="Export to PDF" 
                                    ...
                                    <Columns>                                        
                                        ...
                                        <telerik:GridTemplateColumn DataField="Precio_Unitario" FilterControlAltText="Filter colPrecio_Unitario column" HeaderText="Precio Unitario sin IVA" UniqueName="Precio_Unitario">
                                            <EditItemTemplate>
                                                <telerik:RadNumericTextBox ID="txtPrecio_Unitario" runat="server" Width="100px" Text='<%# Bind("Precio_Unitario") %>' AutoPostBack="true" OnTextChanged="txtPrecio_Unitario_TextChanged" MinValue="0" DataType="System.Double"> 
                                                </telerik:RadNumericTextBox>  
        ...
        <asp:Panel ID="PanelSeccionInformativa" runat="server" Visible="True">
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="LblKvar" runat="server" Text=""></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="GridView1" AutoGenerateColumns="False" runat="server">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CPromedioODemMax" DataFormatString="{0:0.0000}" HeaderText="Consumo" />
                                            <asp:BoundField DataField="CargoAdicional" DataFormatString="{0:0.0000}" HeaderText="Costo Mensual" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadNumericTextBox ID="RadTotalAhorro" runat="server" 
                                        ...
                                        <NumberFormat KeepNotRoundedValue="True" ZeroPattern="n" />
                                    </telerik:RadNumericTextBox>                       
                                </td>
                            </tr>
                            <tr>
