...
namespace PAEEEM.Entities
{
    public class CreditEntity
    {
        ...
        private int _cve_sector_economico;
        public int Cve_Sector_economico
        {
            get { return _cve_sector_economico; }
            set { this._cve_sector_economico = value; }
        }
