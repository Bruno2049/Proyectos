/* ----------------------------------------------------------------------
 * File Name:CAT_CENTRO_DISP_SUCURSALEntity.cs
 * 
 * Create Author: Tina
 * 
 * Create DateTime: 2011/10/26
 *
 * Description: CAT_CENTRO_DISP_SUCURSAL business entity
 *----------------------------------------------------------------------*/
...
{
    [Serializable()]
    public class CAT_CENTRO_DISP_SUCURSALModel
    {
        /// <summary>
        /// Id_Centro_Disp_Sucursal
        /// </summary>
        private int _Id_Centro_Disp_Sucursal;
        public int Id_Centro_Disp_Sucursal
        {
            get { return _Id_Centro_Disp_Sucursal; }
            set { _Id_Centro_Disp_Sucursal = value; }
        }
        /// <summary>
        /// Id_Centro_Disp
        /// </summary>
        ...
        /// <summary>
        /// Dt_Fecha_Centro_Disp_Sucursal
        /// </summary>
        private object _Dt_Fecha_Centro_Disp_Sucursal;
        public object Dt_Fecha_Centro_Disp_Sucursal
        {
            get { return _Dt_Fecha_Centro_Disp_Sucursal; }
            set
            {
                if (value == null)
                {
                    _Dt_Fecha_Centro_Disp_Sucursal = DBNull.Value;
                }
                else
                {
                    _Dt_Fecha_Centro_Disp_Sucursal = value;
                }
            }
        }
        /// <summary>
        ...
        /// <summary>
        /// Codigo_Centro_Disp_Sucursal
        /// </summary>
        private string _Codigo_Centro_Disp_Sucursal;
        public string Codigo_Centro_Disp_Sucursal
        {
            get { return _Codigo_Centro_Disp_Sucursal; }
            set { _Codigo_Centro_Disp_Sucursal = value; }
        }
