...
namespace PAEEEM.BussinessLayer
{
    public class US_NAVEGACIONBll
    {
        ...
        {
            return US_NAVEGACIONDal.ClassInstance.ObtenNavegacionRolUsuario(roleId, userId,rootValue);
        }

        public string ObtenUrlNavegacion(int roleId, int userId, string rootValue)
        {
            return US_NAVEGACIONDal.ClassInstance.ObtenURLNavegacion(roleId, userId, rootValue);
        }
    }
}
