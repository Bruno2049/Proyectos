            ...
            <ContentTemplate>
                ...
                <table width="100%">
                    ...
                    <caption>
                        ...
                        <tr>
                            <td width="30%">
                                <asp:CheckBox ID="ckbBranch" runat="server" AutoPostBack="True" CssClass="CheckBox" OnCheckedChanged="ckbBranch_CheckedChanged" Text="Sucursal" />
                            </td>
                            <td width="15%">
                                <asp:Label ID="lblSupplier" runat="server" CssClass="Label_1" Text="Nombre o Razón Social (Matriz)"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="drpSupplier" runat="server" CssClass="DropDownList">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="drpSupplierRequired" runat="server" ControlToValidate="drpSupplier" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Save"> </asp:RequiredFieldValidator>
                            </td>
                        </tr>
                    </caption>
                </table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtClave" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtClaveRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
                <br />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtSocialName" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtSocialNameRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtBusinessName" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtBusinessNameRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%">
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRFC" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtRFCRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
                <br />
                <table width="100%">
                    <div>
                        ...
                        <tr>
                            <td width="11%">
                                <asp:Label ID="Label5" runat="server" CssClass="Label_3" Text="Calle del Domicilio"></asp:Label>
                            </td>
                            <td width="18%">
                                <asp:TextBox ID="txtPartCalle" runat="server" CssClass="TextBox_1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="txtPartCalleRequired" runat="server" ControlToValidate="txtPartCalle" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Save"> </asp:RequiredFieldValidator>
                            </td>
                            <td width="11%">
                                <asp:Label ID="Label6" runat="server" CssClass="Label_3" Text="Número"></asp:Label>
                            </td>
                            <td width="20%">
                                <asp:TextBox ID="txtPartNum" runat="server" CssClass="TextBox_1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="txtPartNumRequired" runat="server" ControlToValidate="txtPartNum" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Save"> </asp:RequiredFieldValidator>
                            </td>
                            <td width="11%">
                                <asp:Label ID="Label7" runat="server" CssClass="Label_3" Text="Código Postal"></asp:Label>
                            </td>
                            <td width="29%">
                                <div>
                                    <asp:TextBox ID="txtPartCP" runat="server" CssClass="TextBox_1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="txtPartCPRequired" runat="server" ControlToValidate="txtPartCP" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Save"> </asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtPartCP" ErrorMessage="(*) Campo Vacío o con Formato Inválido" ValidationExpression="^\d{5}$"> </asp:RegularExpressionValidator>
                                </div>
                            </td>
                        </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="drpPartEstado" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="drpPartEstadoRequired"> </asp:RequiredFieldValidator>
                        </td>
                        <td width="13%">
                        ...
                        <td width="41%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="drpPartDelegMunicipio" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="drpPartDelegMunicipioRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
                <br />
                    ...
                    <tr>
                        ...
                        <td width="18%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFiscalCalle" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtFiscalCalleRequired"> </asp:RequiredFieldValidator>
                        </td>
                        <td width="11%">
                        ...
                        <td width="20%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFiscalNum" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtFiscalNumRequired"> </asp:RequiredFieldValidator>
                        </td>
                        <td width="11%">
                        ...
                        <td width="29%">
                            <div>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtFiscalCP" ErrorMessage="(*) Campo Obligatorio"
                                    ValidationGroup="Save" ID="txtFiscalCPRequired"> </asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator runat="server" ValidationExpression="^\d{5}$" ControlToValidate="txtFiscalCP"
                                    ErrorMessage="(*) Campo Vacío o con Formato Inválido" ID="RegularExpressionValidator2"> </asp:RegularExpressionValidator>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="drpFiscalEstado" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="drpFiscalEstadoRequired"> </asp:RequiredFieldValidator>
                        </td>
                        <td width="13%">
                        ...
                        <td width="41%">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="drpFiscalDelegMunicipio" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="drpFiscalDelegMunicipioRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
                <br />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRepresentativeName" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtRepresentativeNameRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%">
                        ...
                        <td>
                            <div>
                                ...
                                <asp:RegularExpressionValidator runat="server" ValidationExpression="^(([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+([;.](([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5}){1,25})+)*$"
                                    ControlToValidate="txtRepresentativeEmail" ErrorMessage="(*) Campo Vacío o con Formato Inválido" ID="RegularExpressionValidator10"> </asp:RegularExpressionValidator>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtTelephone" ErrorMessage="(*) Campo Obligatorio"
                                    ValidationGroup="Save" ID="txtTelephoneRequired"> </asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator runat="server" ValidationExpression="^((\d{10}))$"
                                    ControlToValidate="txtTelephone" ErrorMessage="(*) Campo Vacío o con Formato Inválido" ID="RegularExpressionValidator12"> </asp:RegularExpressionValidator>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtLegalName" ErrorMessage="(*) Campo Obligatorio"
                                ValidationGroup="Save" ID="txtLegalNameRequired"> </asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
