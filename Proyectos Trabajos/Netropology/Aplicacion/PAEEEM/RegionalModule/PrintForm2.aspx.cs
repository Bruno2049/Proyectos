...
namespace PAEEEM
{
    public partial class PrintForm2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    IReportServerCredentials iReportServerCredential = new BasicReportCredentials2(userName, passWord, domainName);
    ...
    public class BasicReportCredentials2 : IReportServerCredentials
    {
        ...
        public BasicReportCredentials2(string UserName, string PassWord, string DomainName)
        {
            _UserName = UserName;
            _PassWord = PassWord;
        ...
        public BasicReportCredentials2()
        {
        }
