<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wuAltaBajaEquipos.ascx.cs" Inherits="PAEEEM.SupplierModule.wuAltaBajaEquipos" %>
...
<%@ Register TagPrefix="cc1" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit, Version=4.1.50508.0, Culture=neutral, PublicKeyToken=28f01b0e84b6d53e" %>
    ...
    <%--<telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="RadAjaxLoadingPanel1" runat="server">--%>
            ...
            <div runat="server" ID="divParseo" Visible="False">
            ...
            <table>
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:Label runat="server" Text="Giro de la Empresa:" CssClass="td_label" Width="155px" ID="lblDX_TIPO_INDUSTRIA"></asp:Label>
                    </td>
                    <td>                       
                        <telerik:RadTextBox ID="txtDX_TIPO_INDUSTRIA" runat="server" Enabled="False" 
                            Width="400px" Skin="Office2010Silver">
                        </telerik:RadTextBox>
                    </td>
                    <td></td>
                    <td>
                        <asp:Label runat="server" Text="RPU:" Width="50px" CssClass="td_label" ID="lblServiceCode" Visible="False"></asp:Label>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtServiceCode" Runat="server" Enabled="False" 
                            Width="150px" Skin="Office2010Silver" style="top: 0px; left: 0px" Visible="False"> </telerik:RadTextBox>                      
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label runat="server" Text="Domicilio:" Width="140px" CssClass="td_label" 
                            ID="lblDX_DOMICILIO_FISC_CP" Visible="False"></asp:Label>
                    </td>
                    <td>                      
                        <telerik:RadTextBox ID="txtDX_DOMICILIO_FISC" runat="server" Enabled="False" 
                            Width="200px" Skin="Office2010Silver" Visible="False">
                        </telerik:RadTextBox>
                    </td>
                    <td></td>
                    <td>
                        <asp:Label runat="server" Text="Codigo Postal:" CssClass="td_label" 
                            Width="155px" ID="lblCodigoPostal" Visible="False"></asp:Label>
                    </td>
                    <td>
            ...
            <table>
                <tr>
                    <td >
                        <asp:Label runat="server" Text="Tecnologia:" CssClass="td_label" ID="Label2" Width="140px"></asp:Label>
                    </td>
                    <td>                       
                    ...
                    <td></td>
                    <td>
                        <asp:Label ID="lblSistema" runat="server" Text="Tarifa Destino:" CssClass="td_label" Width="155px" 
                ...
                <table>
                 ...
                 <div>            
                   <telerik:RadGrid ID="rgEquiposBaja" runat="server" 
                        ...
                        GridLines="None" Skin="Office2010Blue" 
                        ...
                        OnSelectedIndexChanged="rgEquiposBaja_SelectedIndexChanged" >
                                ...
                                <MasterTableView DataKeyNames="ID" EditMode="InPlace" >
                                    ...
                                    <Columns>                                        
                                        ...
                                        <telerik:GridButtonColumn UniqueName="colEliminar" ConfirmText="¿Desea eliminar el equipo de baja" Text="Eliminar"
                                        ...
                                        <telerik:GridTemplateColumn DataField="Cve_Consumo" FilterControlAltText="Filter colCve_Capacidad column" HeaderText="Capacidad / Sistema" UniqueName="Cve_Consumo">
                                            <EditItemTemplate>
                                                <telerik:RadNumericTextBox ID="txtCve_Capacidad" runat="server" Width="80px" 
                                                 Visible="false" MinValue="1" MaxValue="100000" NumberFormat-DecimalDigits="2" MaxLength="5" >
            ...
            <fieldset id="fSEA" runat="server">
                ...
                <div>
                   <telerik:RadGrid ID="rgEquiposAlta" runat="server" 
                        ...
                        OnUpdateCommand="rgEquiposAlta_UpdateCommand" Skin="Office2010Blue" 
                        ...
                        OnItemCommand="rgEquiposAlta_ItemCommand">
                                ...
                                <MasterTableView DataKeyNames="ID" EditMode="InPlace" NoMasterRecordsText="No hay equipos de alta eficiencia"
                                    ...
                                    <Columns>                                        
                                         ...
                                         <telerik:GridButtonColumn UniqueName="colEliminar" ConfirmText="¿Desea eliminar el equipo de alta"
                                        ...
                                        <telerik:GridTemplateColumn DataField="Dx_Sistema" FilterControlAltText="Filter colPrecio_Distribuidor column" HeaderText="Capacidad" UniqueName="No_Capacidad">
                                            <EditItemTemplate>
                                                <asp:Label ID="lblNo_Capacidad" runat="server" Width="100px" ReadOnly="true" Text='<%# Bind("No_Capacidad") %>'></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblNo_Capacidadr" runat="server" Text='<%# Eval("Dx_Sistema") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn DataField="Cantidad" FilterControlAltText="Filter colCantidad column" HeaderText="Cantidad" UniqueName="Cantidad">
                                            <EditItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn DataField="Precio_Distribuidor" FilterControlAltText="Filter colPrecio_Distribuidor column" HeaderText="Precio Distribuidor Sin IVA" UniqueName="Precio_Distribuidor">
                                            <EditItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn DataField="Precio_Unitario" FilterControlAltText="Filter colPrecio_Unitario column" HeaderText="Precio Unitario Sin IVA" UniqueName="Precio_Unitario">
                                            <EditItemTemplate>
                                ...
                                <ActiveItemStyle BackColor="#C4D2FF" />
                                <FilterMenu EnableImageSprites="False">
                                </FilterMenu>
                            </telerik:RadGrid>             
                </div>
             ...
             <div style="float:right;width:40%;margin:0px">
                 <fieldset>
                     ...
                     <telerik:RadGrid ID="rgPresupuesto" runat="server" CellSpacing="0" 
                         GridLines="None" Skin="Office2010Blue" Culture="es-MX" 
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
            ...
            <br /><br/><br/>            
            <div style="width:40%;margin:0px">
                <telerik:RadButton ID="RadButton1" Visible="False" runat="server" Text="Reliza Calculos" 
                    onclick="RadButton1_Click">
                </telerik:RadButton>
                <br/>
                <telerik:RadButton ID="RadButton3" runat="server" Visible="False" Text="Ver Resumen">
                </telerik:RadButton>
                <br/>
                <telerik:RadButton ID="RadButton5" Visible="False" runat="server" Text="Generar Solicitud" 
                    onclick="RadButton5_Click">
                </telerik:RadButton>
                <br/>
                <telerik:RadButton ID="RadBtnTablaAmortizacion" Visible="True" runat="server" 
                    Text="Tabla de Amortizacion" onclick="RadBtnTablaAmortizacion_Click" >
                </telerik:RadButton>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <telerik:RadButton ID="RadBtnEditaPresupuesto" Visible="True" runat="server" 
                    Text="Editar Presupuesto" onclick="RadBtnEditaPresupuesto_Click" >
                </telerik:RadButton>
                <br/>
            </div>
            <table style="width: 100%">
                <tr>
                    <td style="width: 40%; horiz-align: left">
                        <div id="divResultados" runat="server" Visible="False" style="float:right;width:100%;margin:0px">                                
                            <fieldset>
                                 <legend>Resultados Validación</legend>
                                 <telerik:RadGrid ID="rgResultados" runat="server" CellSpacing="0" 
                                     GridLines="None" Skin="Office2010Blue" Culture="es-MX" 
                                     AutoGenerateColumns="False" ShowHeader="False" >
                                    <ClientSettings EnableRowHoverStyle="True">
                                        <Selecting CellSelectionMode="None" />
                                    </ClientSettings>
                                    <MasterTableView DataKeyNames="IdResultado">
                                        <CommandItemSettings ExportToPdfText="Export to PDF" />
                                        <RowIndicatorColumn FilterControlAltText="Filter RowIndicator column" 
                                            Visible="True">
                                            <HeaderStyle Width="20px" />
                                        ...
                                        <Columns>                              
                                            <telerik:GridBoundColumn DataField="Nombre" HeaderStyle-Width="70%"
                                                FilterControlAltText="Filter column column" UniqueName="Nombre">
                                            </telerik:GridBoundColumn>
