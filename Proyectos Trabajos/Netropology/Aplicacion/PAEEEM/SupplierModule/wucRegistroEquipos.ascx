<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucRegistroEquipos.ascx.cs" Inherits="PAEEEM.SupplierModule.wucRegistroEquipos" %>
...
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
 ...
 <style type="text/css">              
        ...
        fieldset {
            ...
            -ms-border-raiud: 5px 5px 5px 5px;           
        }
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="btnAgregar">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="btnAgrupar" /> 
                <telerik:AjaxUpdatedControl ControlID="btnDesagrupar" /> 
                <telerik:AjaxUpdatedControl ControlID="btnAgregarEquipoAltaEficiencia" />                                                             
                <telerik:AjaxUpdatedControl ControlID="rgEquiposBaja" LoadingPanelID="RadAjaxLoadingPanel1"/> 
               
            </UpdatedControls>
        </telerik:AjaxSetting>
         <telerik:AjaxSetting AjaxControlID="rgEquiposBaja">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rgEquiposAlta" LoadingPanelID="RadAjaxLoadingPanel1"/>                  
            </UpdatedControls>
        </telerik:AjaxSetting> 
        <telerik:AjaxSetting AjaxControlID="btnAgregarEquipoAltaEficiencia">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rgEquiposAlta" LoadingPanelID="RadAjaxLoadingPanel1"/>                  
            </UpdatedControls>
        </telerik:AjaxSetting>        
        ...
        <div>
            <fieldset id="fielSetEB" runat="server">
                ...
                <%--   <telerik:RadGrid ID="rgEquiposBaja" runat="server" 
                                ...
                                onitemdatabound="rgEquiposBaja_ItemDataBound" >
                                ...
                                <MasterTableView DataKeyNames="ID" EditMode="InPlace" >
                                    ...
                                    <Columns>                                        
                                        <telerik:GridButtonColumn CommandName="Seleccionar" FilterControlAltText="Filter column column" Text="Seleccionar" UniqueName="colSeleccionar">
                                         ...
                                         <telerik:GridEditCommandColumn ButtonType="ImageButton" EditText="Editar" CancelText="Cancelar" UpdateText="Actualizar" UniqueName="colEditar" FilterControlAltText="Filter EditCommandColumn column">
                                            <HeaderStyle Width="40" />
                                        </telerik:GridEditCommandColumn>                                     
                                        <telerik:GridButtonColumn ConfirmText="¿Desea eliminar el equipo de baja"
                                        ...
                                        <telerik:GridTemplateColumn DataField="Ft_Tipo_Producto" FilterControlAltText="Filter colFt_Tipo_Producto column" HeaderText="Producto" UniqueName="Ft_Tipo_Producto">
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="cboFt_Tipo_Producto" runat="server" Skin="Office2010Silver">                                                    
                                                </telerik:RadComboBox>
                                        ...
                                        <telerik:GridTemplateColumn DataField="Cve_Consumo" FilterControlAltText="Filter colCve_Capacidad column" HeaderText="Capacidad / Sistema" UniqueName="Cve_Consumo">
                                            <EditItemTemplate>
                                                <telerik:RadNumericTextBox ID="txtCve_Capacidad" runat="server" Width="80px" Text='<%# Bind("Dx_Consumo") %>' AutoPostBack="True" OnTextChanged="txtCve_Capacidad_OnTextChanged"
                                        ...
                                        <telerik:GridTemplateColumn DataField="Cantidad" FilterControlAltText="Filter colCantidad column" HeaderText="Cantidad" UniqueName="Cantidad">
                                            <EditItemTemplate>
                                                ...
                                                OnTextChanged="txtCantidad_OnTextChanged" MaxLength="3" MaxValue="999" MinValue="0">                                                
                                                </telerik:RadNumericTextBox>
                                   ...
                                   <GroupByExpressions>
                                        <telerik:GridGroupByExpression>
                                            <SelectFields>
                                                <telerik:GridGroupByField FieldAlias="Dx_Tecnologia" FieldName="Dx_Tecnologia" FormatString="" HeaderText="" />
                                            </SelectFields>
                                            <GroupByFields>
                                                <telerik:GridGroupByField FieldAlias="Dx_Tecnologia" FieldName="Dx_Tecnologia" FormatString="" HeaderText="" />
                                            </GroupByFields>
            ...
            <fieldset id="fSEA" runat="server">
                ...
                <div>
                  <%-- <telerik:RadGrid ID="rgEquiposAlta" runat="server" 
                                ...
                                OnInsertCommand="rgEquiposAlta_InsertCommand">
                                <ClientSettings EnableRowHoverStyle="true">
                                   <Selecting CellSelectionMode="None" />
                                </ClientSettings>
                                <MasterTableView DataKeyNames="ID" EditMode="InPlace" NoMasterRecordsText="No hay equipos de alta eficiencia"
                                    ...
                                    <Columns>                                        
                                         <telerik:GridEditCommandColumn ButtonType="ImageButton" EditText="Editar" FilterControlAltText="Filter EditCommandColumn column">
                                            <HeaderStyle Width="40" />
                                        </telerik:GridEditCommandColumn>
                                        ...
                                        <telerik:GridTemplateColumn DataField="Cve_Marca" FilterControlAltText="Filter colGrupo column" HeaderText="Marca" UniqueName="Cve_Marca">
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="cboCve_Marca" AutoPostBack="True" runat="server" DataTextField="Elemento" DataValueField="IdElemento" Skin="Office2010Silver" OnSelectedIndexChanged="cboCve_Marca_SelectedIndexChanged">
                                                    <Items>
                                        ...
                                        <telerik:GridTemplateColumn DataField="Cve_Modelo" FilterControlAltText="Filter colCve_Modelo column" HeaderText="Modelo" UniqueName="Cve_Modelo">
                                            <EditItemTemplate>
                                                ...
                                                AutoPostBack="true" OnSelectedIndexChanged="cboCve_Modelo_SelectedIndexChanged" Skin="Office2010Silver">
                                                    <Items>
                                                        <telerik:RadComboBoxItem Text="Seleccione" Value="-1"  />
                                                    </Items>
                                                </telerik:RadComboBox>
