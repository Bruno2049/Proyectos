<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Site.Master" CodeBehind="CreditRequest.aspx.cs"
    Inherits="PAEEEM.SupplierModule.CreditRequest" Title="Alta de Solicitud de Crédito" MaintainScrollPositionOnPostback="true"%>
    ...
    <asp:UpdatePanel ID="panel" runat="server">
        <ContentTemplate>
            ...
            <asp:Wizard ID="wizardPages" runat="server" DisplaySideBar="false" Style="width:auto"
                ...
                <WizardSteps>
                    <%--<asp:WizardStep runat="server" ID="wizValidacionPyme" StepType="Start">
                        <div>
                            <uc1:wucValidaPyme id="wucValidaPyme1" runat="server"  />
                        </div>
                    </asp:WizardStep>--%>
                                                    ...
                                                    <asp:Panel runat="server" ID="pnl1">
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <tr>
                                                                        <td width="153px">
                                                                            <div>
                                                                                <asp:Label CssClass="Label" Font-Size="11pt" Width="160px" 
                                                                                    ID="lblDX_SECTOR_ECONOMICO" runat="server" Text="Sector Económico"></asp:Label>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div>
                                                                                <asp:DropDownList ValidationGroup="Siguiente" 
                                                                                    CssClass="DropDownList" Font-Size="11px" ToolTip="(Campo Obligatorio)" Width="250px" ID="ddlDX_SECTOR_ECONOMICO" runat="server">
                                                                        ...
                                                                        <td>
                                                                            <div>
                                                                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlDX_SECTOR_ECONOMICO"
                                                                                    ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Siguiente" ID="rfvDX_SECTOR_ECONOMICO">
                                                                                </asp:RequiredFieldValidator>
                                                                            </div>
                                                                        </td>
                                                                        <td width="153px">
                                                            ...
                                                            <tr>
                                                                <td width="150px">
                                                                    <div>
                                                                        <asp:Label runat="server" Text="Total de Gastos Mensuales" CssClass="Label"
                                                                            Font-Size="11pt" Width="150px" ID="lblMT_GASTOS_MES_EMPRESA"></asp:Label>
                                                                    </div>
                                                                </td>

                                                                <td width="150px">
                                                                    <div>                                                                        
                                                                        <asp:TextBox ID="txtMT_GASTOS_MES_EMPRESA" runat="server" CssClass="TextBox_1" Font-Size="11px" Width="250px"></asp:TextBox>
                                                                    </div>
                                                                </td>                       
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <asp:RegularExpressionValidator runat="server" ValidationExpression="^\d+(\.\d+)?$" Height="0px"
                                                                            ...
                                                                            ID="RegularExpressionValidator7" ToolTip="(Formato Numérico con 2 Decimales)">
                                                                        </asp:RegularExpressionValidator>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <asp:Label ID="lblMT_VENTAS_MES_EMPRESA" runat="server" CssClass="Label" Font-Size="11pt" Text="Promedio Mensual de Ventas" Width="150px"></asp:Label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <asp:RegularExpressionValidator runat="server" ValidationExpression="^\d+(\.\d+)?$"
                                                                            ...
                                                                            ToolTip="(Formato Numérico con 2 Decimales)" ID="RegularExpressionValidator6" Height="0px">
                                                                        </asp:RegularExpressionValidator>
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator42" runat="server" ControlToValidate="txtMT_GASTOS_MES_EMPRESA" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Siguiente">
                                                                        </asp:RequiredFieldValidator>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div>
                                                                            <asp:Label ID="lblNO_CONSUMO_PROMEDIO" runat="server" CssClass="Label_2" Font-Size="11pt" Text="Consumo Promedio" Visible="False" Width="150px"></asp:Label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <asp:TextBox ID="txtNO_CONSUMO_PROMEDIO" runat="server" CssClass="TextBox_1" Font-Size="11px" Visible="False" Width="250px"></asp:TextBox>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="txtNO_CONSUMO_PROMEDIO" Enabled="false" ErrorMessage="(*) Campo Obligatorio" ToolTip="(Formato Numérico Enteros)" ValidationExpression="^[0-9]*[1-9][0-9]*$" ValidationGroup="Siguiente">
                                                                        </asp:RegularExpressionValidator>
                                                                        </div>
                                                                    </td>
                                                                    <td width="155px">
                                                                        <div>
                                                                            <asp:Label ID="lblDX_EMAIL_REPRE_LEGAL" runat="server" CssClass="Label" Font-Size="11pt" Text="E-mail del Representante Legal (*)" Width="155px"></asp:Label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <asp:TextBox ID="txtDX_EMAIL_REPRE_LEGAL" runat="server" CssClass="TextBox_1" Font-Size="11px" ToolTip="(Formato [a-9-&amp;][@][a-9-&amp;][.][a])" ValidationGroup="Siguiente" Width="250px"></asp:TextBox>
                                                                        </div>
                                                                    </td>
                                                                    <td width="30px">
                                                                        <div>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtDX_EMAIL_REPRE_LEGAL" ErrorMessage="(*) Campo Obligatorio" Height="0px" ValidationExpression="^(([a-zA-Z0-9_\-\.ñáéíóúü]+)@([a-zA-Z0-9_\-\.ñáéíóúü]+)\.([a-zA-Zñáéíóúü]{2,5}){1,25})+([;.](([a-zA-Z0-9_\-\.ñáéíóúü]+)@([a-zA-Z0-9_\-\.ñáéíóúü]+)\.([a-zA-Zñáéíóúü]{2,5}){1,25})+)*$" ValidationGroup="Siguiente">
                                                                        </asp:RegularExpressionValidator>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator40" runat="server" ControlToValidate="txtDX_EMAIL_REPRE_LEGAL" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Siguiente">
                                                                        </asp:RequiredFieldValidator>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <div>
                                                                            <asp:Label ID="lblNumeroEmpleados" runat="server" CssClass="Label" Font-Size="11pt" Text="Número de Empleados" Width="150px"></asp:Label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <asp:TextBox ID="txtNO_EMPLEADOS" runat="server" CssClass="TextBox_1" Font-Size="11px" Width="250px"></asp:TextBox>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <asp:RegularExpressionValidator ID="reNO_EMPLEADOS" runat="server" ControlToValidate="txtNO_EMPLEADOS" Enabled="false" ErrorMessage="(*) Campo Obligatorio" ToolTip="(Formato Numérico Enteros)" ValidationExpression="^[0-9]*[1-9][0-9]*$" ValidationGroup="Siguiente">
                                                                        </asp:RegularExpressionValidator>
                                                                            <asp:RequiredFieldValidator ID="rfvNO_EMPLEADOS" runat="server" ControlToValidate="txtNO_EMPLEADOS" ErrorMessage="(*) Campo Obligatorio" ValidationGroup="Siguiente">
                                                                        </asp:RequiredFieldValidator>
                                                                        </div>
                                                                    </td>
                                                                </tr>
