...
{
    public partial class CreditRequest : Page
    {
        ...
        public int TipoSociedad
        {
            get
            {
                return ViewState["TipoSociedad"] == null ? 1 : int.Parse(ViewState["TipoSociedad"].ToString());
            }
            set
            {
                ViewState["TipoSociedad"] = value;
            }
        }

        //added by tina 2012-07-26
        public float PctTasaIva
        {
            get
            {
                return ViewState["PctTasaIva"] == null ? 0 : float.Parse(ViewState["PctTasaIva"].ToString());
            }
            set
            {
                ViewState["PctTasaIva"] = value;
            }
        }
        //end
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    var dtDelegMunicipio = CAT_DELEG_MUNICIPIOBLL.ClassInstance.Get_All_CAT_DELEG_MUNICIPIO();
                    ...
                    ProgramDt = CAT_PROGRAMABLL.ClassInstance.Get_CAT_PROGRAMAbyPk(Global.PROGRAM.ToString(CultureInfo.InvariantCulture));//Changed by Jerry 2011/08/08
            ...
            {
                ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "PageLoad", "alert('" + ex.Message + "');", true);
            }
        }
        ...
        {
            var dtCreditTemp = K_CREDITO_TEMPDAL.ClassInstance.Get_K_Credito_Temp(UserId);
            ...
            txtDX_NO_IDENTIFICACION_REPRE_LEGAL.Text = dtCreditTemp.Rows[0]["Dx_No_Identificacion_Repre_Legal"].ToString();
            txtMT_VENTAS_MES_EMPRESA.Text = dtCreditTemp.Rows[0]["Mt_Ventas_Mes_Empresa"].ToString();
            txtMT_GASTOS_MES_EMPRESA.Text = dtCreditTemp.Rows[0]["Mt_Gastos_Mes_Empresa"].ToString();
            ...
            ddlDX_SECTOR_ECONOMICO.SelectedIndex = ddlDX_SECTOR_ECONOMICO.Items.IndexOf(ddlDX_SECTOR_ECONOMICO.Items.FindByValue(dtCreditTemp.Rows[0]["Cve_Sector"].ToString()));
            txtNO_EMPLEADOS.Text = dtCreditTemp.Rows[0]["No_Empleados"].ToString();
        ...
        private void LoadCreditRecord(DataTable dtAllCreditProperties)
        {
            ...
            DateTime birthDate;
            txtBirthDate.Text = DateTime.TryParse(dtAllCreditProperties.Rows[0]["Dt_Nacimiento_Fecha"].ToString(), out birthDate) ? birthDate.ToString("yyyy-MM-dd") : dtAllCreditProperties.Rows[0]["Dt_Nacimiento_Fecha"].ToString();
            ...
            txtDX_NO_IDENTIFICACION_REPRE_LEGAL.Text = dtAllCreditProperties.Rows[0]["Dx_No_Identificacion_Repre_Legal"].ToString();
            float valor;
            txtMT_VENTAS_MES_EMPRESA.Text = float.TryParse(dtAllCreditProperties.Rows[0]["Mt_Ventas_Mes_Empresa"].ToString(), out valor) ? ((int)valor).ToString(CultureInfo.InvariantCulture) : dtAllCreditProperties.Rows[0]["Mt_Ventas_Mes_Empresa"].ToString();
            txtMT_GASTOS_MES_EMPRESA.Text = float.TryParse(dtAllCreditProperties.Rows[0]["Mt_Gastos_Mes_Empresa"].ToString(), out valor) ? ((int)valor).ToString(CultureInfo.InvariantCulture) : dtAllCreditProperties.Rows[0]["Mt_Gastos_Mes_Empresa"].ToString();
            txtDX_EMAIL_REPRE_LEGAL.Text = dtAllCreditProperties.Rows[0]["Dx_Email_Repre_legal"].ToString();
            txtNO_CONSUMO_PROMEDIO.Text = float.TryParse(dtAllCreditProperties.Rows[0]["No_consumo_promedio"].ToString(), out valor) ? ((int)valor).ToString(CultureInfo.InvariantCulture) : dtAllCreditProperties.Rows[0]["No_consumo_promedio"].ToString();
            //Second Section
            ...
            txtDt_BirthDate_Aval.Text = DateTime.TryParse(dtAllCreditProperties.Rows[0]["Dt_BirthDate_Aval"].ToString(), out birthDate) ? birthDate.ToString("yyyy-MM-dd") : dtAllCreditProperties.Rows[0]["Dt_BirthDate_Aval"].ToString();
            // RSA 20131007 Add fields for both RFC and CURP
            ...
            ddlDX_SECTOR_ECONOMICO.SelectedIndex = ddlDX_SECTOR_ECONOMICO.Items.IndexOf(ddlDX_SECTOR_ECONOMICO.Items.FindByValue(dtAllCreditProperties.Rows[0]["Cve_Sector"].ToString()));
            txtNO_EMPLEADOS.Text = dtAllCreditProperties.Rows[0]["No_Empleados"].ToString();
        ...
        private void BindddlDX_SECTOR_ECONOMICO()
        {
            var sectorEconomicoType = LogicaNegocios.SolicitudCredito.CatalogosSolicitud.ObtenCatSectorEconomico();

            if (sectorEconomicoType == null) return;
            ddlDX_SECTOR_ECONOMICO.DataSource = sectorEconomicoType;
            ddlDX_SECTOR_ECONOMICO.DataValueField = "Cve_Sector";
            ddlDX_SECTOR_ECONOMICO.DataTextField = "Dx_Sector";
            ddlDX_SECTOR_ECONOMICO.DataBind();
            ddlDX_SECTOR_ECONOMICO.Items.Insert(0, "");

            ddlDX_SECTOR_ECONOMICO.SelectedIndex = sectorEconomicoType.Count > 0 ? 1 : 0;
        }
        
        private void BindddlDX_TIPO_INDUSTRIA()
        {
            var industriaTypeDataTable = CAT_TIPO_INDUSTRIABLL.ClassInstance.Get_All_CAT_TIPO_INDUSTRIA();

            if (industriaTypeDataTable == null) return;
            ...
            ddlDX_TIPO_INDUSTRIA.SelectedIndex = industriaTypeDataTable.Rows.Count > 0 ? 1 : 0;
        }
        ...
        protected void ckbFg_mismo_domicilio_CheckedChanged(object sender, EventArgs e)
        {
            if (ckbFg_mismo_domicilio.Checked)
            {
                ...
                if (ddlDx_nombre_estado_Neg.SelectedValue != "" && ddlDx_nombre_estado_Neg.SelectedValue != ddlDx_nombre_estado.SelectedValue)
                {                    
                    //ddlDx_nombre_estado_Neg.SelectedIndex =ddlDx_nombre_estado_Neg.Items.IndexOf(ddlDx_nombre_estado_Neg.Items.FindByValue(ddlDx_nombre_estado.SelectedValue));
                    ddlDx_nombre_estado_Neg.SelectedValue = ddlDx_nombre_estado.SelectedValue;
                    ddlDx_nombre_estado_Neg_SelectedIndexChanged(this, new EventArgs());
        ...
        //                ScriptManager.RegisterStartupScript(Page, GetType(), "savefail", "alert('" + strMsg + "');", true);
      ...
      private void SetupTooltip(string controlName)
        ...
        protected void ddlProduct_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ProductDataTable != null && ProductDataTable.Rows.Count > 0)
                {
                    ...
                    double precio = (double.Parse(ProductDataTable.Rows[0]["Mt_Precio_Unitario"].ToString())) / (1 + PctTasaIva / 100);
            ...
            {
                ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + ex.Message + "');", true);
            }
        }
        /// <summary>
        /// Input cantidad 
        ...
        protected void txtCantidad_TextChanged(object sender, EventArgs e)
        {
            ...
            if (!IsNumeric(Cantidad))
            {
                ...
                ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                return;
            }
        ...
        protected void wizardPages_NextButtonClick(object sender, WizardNavigationEventArgs e)
        {
            try
            {
                ...
                if (e.CurrentStepIndex == 0)//First step
                {
                    ...
                    {
                        if (!ValidateServiceCode(txtNO_RPU.Text, out ErrorCode, out StatusFlag))
                        {/*
                          ...
                          */
                            //Added by Jerry 2011/08/12
                            //creditModel.No_Credito = "PAEEEM" + RGN_CFE.Substring(2, 5) + /*ZoneType + "-" + "1"TBD +*/ string.Format("{0:00000}", Convert.ToInt32(LsUtility.GetNumberSequence("CREDITO")));
                            ...
                            {
                                e.Cancel = true;
                                ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + ErrorCode.Replace("\r", "\\r").Replace("\n", "\\n") + "');", true);
                                //Response.Redirect("CreditMonitor.aspx");
                            }
                        }
                        ...
                        {
                            var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateRFCPersona") as string;
                            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                            e.Cancel = true;
                        }
                        else if (!ValidateCURP(txtDX_RFC.Text.ToUpper(), txtDX_CURP.Text.ToUpper()))
                        {
                            var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateCURPPersona") as string;
                            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                            e.Cancel = true;
                        }
                        ...
                        {
                            var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateRFCAval") as string;
                            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                            e.Cancel = true;
                        }
                        else if (!ValidateCURP(txtDx_RFC_Aval.Text.ToUpper(), txtDx_CURP_Aval.Text.ToUpper()))
                        {
                            var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateCURPAval") as string;
                            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                            e.Cancel = true;
                        }
                        ...
                        {
                            var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateAgeAval") as string;
                            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                            e.Cancel = true;
                            return;
                        }
                        ...
                        else
                        {
                            if (CompanyType.PERSONAFISICA == (CompanyType)Enum.Parse(typeof(CompanyType), ddlDX_TIPO_SOCIEDAD.SelectedValue) || CompanyType.REPECO == (CompanyType)Enum.Parse(typeof(CompanyType), ddlDX_TIPO_SOCIEDAD.SelectedValue))
                            {
                                ...
                                {
                                    var strMsg = HttpContext.GetGlobalResourceObject("DefaultResource", "ValidateAge") as string;
                                    ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                                    e.Cancel = true;
                                    return;
                                }
                    ...
                    var aplicaPYME = LogicaNegocios.SolicitudCredito.CatalogosSolicitud.ClassInstance.ValidaEstratificacionPYME(Convert.ToInt32(txtNO_EMPLEADOS.Text), Convert.ToDecimal(txtMT_VENTAS_MES_EMPRESA.Text), Convert.ToInt32(ddlDX_SECTOR_ECONOMICO.SelectedValue));
                    K_CREDITO_LOG creditoLog = GetDatosTemporalLog();

                    if (!aplicaPYME)
                    {
                        creditoLog.Cve_Estatus_Credito = (int)CreditStatus.CLASIFICACION_PYME_INCORRECTA;
                        var insertLog = LogicaNegocios.SolicitudCredito.SolicitudCreditoAcciones.ClassInstance.InsertaCreditoLog(creditoLog);

                        if (insertLog)
                        {
                            /*INSERTAR EVENTO Clasificacion PYME DE SOLICITUD DE CREDITO EN LOG*/
                            Insertlog.InsertarLog(Convert.ToInt16(Session["IdUserLogueado"]),
                                Convert.ToInt16(Session["IdRolUserLogueado"]), Convert.ToInt16(Session["IdDepartamento"]), "SOLICITUD DE CREDITO", "CLASIFICACION PyME",
                                creditoLog.No_RPU.ToString(CultureInfo.InvariantCulture), "", "NO ES PyME", "", "");
                        }

                        const string strMsg = "El Cliente no cumple con las condiciones de una PYME";
                        ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
                        e.Cancel = true;
                    }
                    else
                    {
                        creditoLog.Cve_Estatus_Credito = (int)CreditStatus.PENDIENTE;
                        var insertLog = LogicaNegocios.SolicitudCredito.SolicitudCreditoAcciones.ClassInstance.InsertaCreditoLog(creditoLog);
                        if (insertLog)
                        {
                            /*INSERTAR EVENTO Clasificacion PYME DE SOLICITUD DE CREDITO EN LOG*/
                            Insertlog.InsertarLog(Convert.ToInt16(Session["IdUserLogueado"]),
                                Convert.ToInt16(Session["IdRolUserLogueado"]), Convert.ToInt16(Session["IdDepartamento"]), "SOLICITUD DE CREDITO", "CLASIFICACION PyME",
                                creditoLog.No_RPU.ToString(CultureInfo.InvariantCulture), "", "PyME", "", "");
                        }
                    }
                }
                ...
                if (e.CurrentStepIndex == 2)
                {
                    ...
                    //end add
                    if (!IsValidRFCAmountLimit(txtDX_RFC.Text, double.Parse(txtTotal.Text, NumberStyles.Currency, System.Threading.Thread.CurrentThread.CurrentCulture)))
                    {
        ...
        protected void wizardPages_FinishButtonClick(object sender, WizardNavigationEventArgs e)
        {
            try
            {
                ...
                EntidadCredito creditModel = null;
                ...
                if (ProgramDt != null && ProgramDt.Rows.Count > 0)
                {
                    ...
                    creditModel.Pct_Tasa_IVA = PctTasaIva;
                    //end
                ...
                for (int i = 0; i < gvTecPro.Rows.Count; i++)
                {
                    ...
                    if (DropDownProduct.SelectedIndex != 0 && DropDownProduct.SelectedIndex != -1)
                    {
                        ...
                        model.Mt_Precio_Unitario = string.IsNullOrEmpty(hfExactGridText1.Value) ? default(decimal)
                            : (decimal)TwoDecimals(double.Parse(hfExactGridText1.Value) * (1 + PctTasaIva / 100));           // +IVA
                        model.Mt_Gastos_Instalacion_Mano_Obra = string.IsNullOrEmpty(txtGastos.Text) ? default(decimal)
                            : (decimal)TwoDecimals(double.Parse(txtGastos.Text) * (1 + PctTasaIva / 100));    // +IVA
                        ...
                        model.Mt_Total = string.IsNullOrEmpty(hfExactSubtotal.Value) ? default(decimal)
                            : (decimal)TwoDecimals(double.Parse(hfExactSubtotal.Value) * (1 + PctTasaIva / 100));   // +IVA
                ...
                else
                {
                    ...
                    if (iResult > 0)
                    {
                        ...
                        //var aplicaPYME = LogicaNegocios.SolicitudCredito.CatalogosSolicitud.ClassInstance.ValidaEstratificacionPYME(creditModel.No_Credito);

                        //if (!aplicaPYME)
                        //{
                        //    using (TransactionScope scope = new TransactionScope())
                        //    {
                        //        iResult = K_CREDITODal.ClassInstance.RechazarCredit(CreditNumber, (int)CreditStatus.RECHAZADO, DateTime.Now, Session["UserName"].ToString(), DateTime.Now.Date);
                        //        scope.Complete();
                        //    }
                            
                        //    string strMSg_Pyme = " El cliente no cumple con las condiciones para ser clasificada como una PYME.";
                        //    ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMSg_Pyme + "');", true);
                        //}
        ...
        protected void btnAddRow_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridViewDataSource.Rows.Count; i++)
            {
                ...
                double value;
                OldRow["PrecioUnitario"] = double.TryParse(hfExactGridText1.Value, out value) ? (value * (1 + PctTasaIva / 100)).ToString() : string.Empty;   // +IVA
                OldRow["Subtotal"] = double.TryParse(hfExactSubtotal.Value, out value) ? (value * (1 + PctTasaIva / 100)).ToString() : string.Empty;          // +IVA
                OldRow["Gastos"] = double.TryParse(txtGastos.Text, out value) ? (value * (1 + PctTasaIva / 100)).ToString() : string.Empty;                   // +IVA
            }
        ...
        protected void gvTecPro_DataBound(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridViewDataSource.Rows.Count; i++)
            {
                ...
                if (DropDownTechnology != null)
                {
                    ...
                    DataTable Technology = CAT_TECNOLOGIABLL.ClassInstance.Get_All_CAT_TECNOLOGIAByProgramAndDxCveCC(Global.PROGRAM.ToString(), User.Id_Usuario, GridViewDataSource.Rows.Count > 1 ? DxCveCcSe : "");//Changed by Jerry 2011/08/08
                ...
                if (i < GridViewDataSource.Rows.Count)
                {
                    ...
                    {
                        hfBasePrice.Value = (value / (double)(1 + PctTasaIva / 100)).ToString();
                    }
                    else
                    {
                        hfBasePrice.Value = "0";
                    ...
                    hfExactGridText1.Value = double.TryParse(GridViewDataSource.Rows[i]["PrecioUnitario"].ToString(), out value) ? (value / (1 + PctTasaIva / 100)).ToString() : "";    // -IVA
                    hfExactSubtotal.Value = double.TryParse(GridViewDataSource.Rows[i]["Subtotal"].ToString(), out value) ? (value / (1 + PctTasaIva / 100)).ToString() : "";           // -IVA
                    txtGridText1.Text = double.TryParse(GridViewDataSource.Rows[i]["PrecioUnitario"].ToString(), out value) ? TwoDecimals(value / (1 + PctTasaIva / 100)).ToString("0.00") : "";   // -IVA
                    txtSubtotal.Text = double.TryParse(GridViewDataSource.Rows[i]["Subtotal"].ToString(), out value) ? TwoDecimals(value / (1 + PctTasaIva / 100)).ToString("0.00") : "";          // -IVA
                    //txtGridText1.ToolTip = hfExactGridText1.Value;
                    // txtSubtotal.ToolTip = hfExactSubtotal.Value;
                    txtGastos.Text = double.TryParse(GridViewDataSource.Rows[i]["Gastos"].ToString(), out value) ? (value / (1 + PctTasaIva / 100)).ToString("0.00") : "";              // -IVA
                }
        ...
        protected void btnPreliminary_Click( object sender, EventArgs e )
        {
            ...
            if ( Result > 0 )
            {
                ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "PreliminarySave", "alert('Salvado temporal exitoso!');", true);
            }
        }
        private K_CREDITO_TEMPEntity GetPreliminaryStoredData()
        {
            ...
            creditTempEntity.Cve_Sector_economico = Convert.ToInt32(ddlDX_SECTOR_ECONOMICO.SelectedValue);
            ...
            creditTempEntity.Cve_Reg_Conyugal_Repre_legal = ddlDX_REG_CONYUGAL_REPRE_LEGAL.SelectedValue;
            creditTempEntity.Cve_Identificacion_Repre_legal = ddlDX_IDENTIFICACION_REPRE_LEGAL.SelectedValue;
            creditTempEntity.Dx_No_Identificacion_Repre_Legal = txtDX_NO_IDENTIFICACION_REPRE_LEGAL.Text;
            creditTempEntity.Mt_Ventas_Mes_Empresa = txtMT_VENTAS_MES_EMPRESA.Text;
            creditTempEntity.Mt_Gastos_Mes_Empresa = txtMT_GASTOS_MES_EMPRESA.Text;
            ...
            creditTempEntity.No_Empleados = Convert.ToInt32(txtNO_EMPLEADOS.Text);
            //section2 data
        ...
        private K_CREDITO_LOG GetDatosTemporalLog()
        {
            K_CREDITO_LOG creditoLog = new K_CREDITO_LOG();
            creditoLog.Cve_Tipo_Sociedad = ddlDX_TIPO_SOCIEDAD.SelectedValue;
            creditoLog.Dx_First_Name = txtName.Text;
            creditoLog.Dx_Last_Name = txtLastname.Text;
            creditoLog.Dx_Mother_Name = txtMotherName.Text;
            creditoLog.Dt_Fecha_Nacimiento = txtBirthDate.Text;
            creditoLog.Cve_Tipo_Industria = ddlDX_TIPO_INDUSTRIA.SelectedValue;
            creditoLog.Cve_Sector = Convert.ToInt32(ddlDX_SECTOR_ECONOMICO.SelectedValue);
            creditoLog.Dx_Telephone = txtTelephone.Text;
            creditoLog.Dx_Email = txtEmail.Text;
            creditoLog.Dx_CURP = txtDX_CURP.Text;
            creditoLog.Dx_Nombre_Comercial = txtDx_Nombre_Comercial.Text;
            creditoLog.Dx_RFC = txtDX_RFC.Text;
            creditoLog.Dx_Nombre_Repre_Legal = txtDX_NOMBRE_REPRE_LEGAL.Text;
            creditoLog.Cve_Acreditacion_Repre_legal = ddlDX_ACREDITACION_REPRE_LEGAL.SelectedValue;
            if (radFG_SEXO_REPRE_LEGAL1.Checked == true)
            {
                creditoLog.Fg_Sexo_Repre_legal = "1";
            }
            else if (radFG_SEXO_REPRE_LEGAL2.Checked == true)
            {
                creditoLog.Fg_Sexo_Repre_legal = "2";
            }
            creditoLog.No_RPU = txtNO_RPU.Text;
            if (radFG_EDO_CIVIL_REPRE_LEGAL1.Checked == true)
            {
                creditoLog.Fg_Edo_Civil_Repre_legal = "1";
            }
            else if (radFG_EDO_CIVIL_REPRE_LEGAL2.Checked == true)
            {
                creditoLog.Fg_Edo_Civil_Repre_legal = "2";
            }
            creditoLog.Cve_Reg_Conyugal_Repre_legal = ddlDX_REG_CONYUGAL_REPRE_LEGAL.SelectedValue;
            creditoLog.Cve_Identificacion_Repre_legal = ddlDX_IDENTIFICACION_REPRE_LEGAL.SelectedValue;
            creditoLog.Dx_No_Identificacion_Repre_Legal = txtDX_NO_IDENTIFICACION_REPRE_LEGAL.Text;
            creditoLog.Mt_Ventas_Mes_Empresa = txtMT_VENTAS_MES_EMPRESA.Text;
            creditoLog.Mt_Gastos_Mes_Empresa = txtMT_GASTOS_MES_EMPRESA.Text;
            creditoLog.Dx_Email_Repre_legal = txtDX_EMAIL_REPRE_LEGAL.Text;
            creditoLog.No_consumo_promedio = txtNO_CONSUMO_PROMEDIO.Text;
            creditoLog.No_Empleados = Convert.ToInt32(txtNO_EMPLEADOS.Text);
            //section2 data
            creditoLog.Dx_Domicilio_Fisc_Calle = txtDx_Domicilio_fisc_calle.Text;
            creditoLog.Dx_Domicilio_Fisc_Num = txtDx_Domicilio_fisc_num.Text;
            creditoLog.Dx_Domicilio_Fisc_CP = txtDx_Domicilio_fisc_cp.Text;
            creditoLog.Cve_Estado_Fisc = ddlDx_nombre_estado.SelectedValue;
            creditoLog.Cve_Deleg_Municipio_Fisc = ddlDx_deleg_municipio.SelectedValue;
            creditoLog.Cve_Tipo_Propiedad_Fisc = ddlDx_Tipo_propiedad.SelectedValue;
            creditoLog.Dx_Tel_Fisc = txtDx_tel_neg.Text;
            creditoLog.Dx_Domicilio_Fisc_Colonia = txtDx_Domicilio_Fisc_Colonia.Text;
            //section3 data
            if (ckbFg_mismo_domicilio.Checked)
            {
                creditoLog.Fg_Mismo_Domicilio = true;
            }
            else
            {
                creditoLog.Fg_Mismo_Domicilio = false;
            }
            creditoLog.Dx_Domicilio_Neg_Calle = txtDx_domicilio_neg_calle.Text;
            creditoLog.Dx_Domicilio_Neg_Num = txtDx_domicilio_neg_num.Text;
            creditoLog.Dx_Domicilio_Neg_CP = txtDx_domicilio_neg_cp.Text;
            creditoLog.Cve_Estado_Neg = ddlDx_nombre_estado_Neg.SelectedValue;
            creditoLog.Cve_Deleg_Municipio_Neg = ddlDx_deleg_municipio_Neg.SelectedValue;
            creditoLog.Cve_Tipo_Propiedad_Neg = ddlDx_Tipo_propiedad_Neg.SelectedValue;
            creditoLog.Dx_Tel_Neg = txtDx_tel_neg_Neg.Text;
            creditoLog.Dx_Domicilio_Neg_Colonia = txtDx_Domicilio_Neg_Colonia.Text;
            //section4 data
            // RSA 20131007 single fields for first, last and mother names, keep a full name field (trim white spaces at end or middle as necesary)
            creditoLog.Dx_Nombre_Aval = ((txtDx_First_Name_aval.Text + " " + txtDx_Last_Name_aval.Text).Trim() + " " + txtDx_Mother_Name_aval.Text).Trim();
            creditoLog.Dx_First_Name_Aval = txtDx_First_Name_aval.Text;
            creditoLog.Dx_Last_Name_Aval = txtDx_Last_Name_aval.Text;
            creditoLog.Dx_Mother_Name_Aval = txtDx_Mother_Name_aval.Text;
            creditoLog.Dt_BirthDate_Aval = txtDt_BirthDate_Aval.Text;
            creditoLog.Dx_RFC_Aval = txtDx_RFC_Aval.Text;
            creditoLog.Dx_CURP_Aval = txtDx_CURP_Aval.Text;
            creditoLog.Dx_RFC_CURP_Aval = txtDx_RFC_Aval.Text;
            creditoLog.Dx_Tel_Aval = txtDx_tel_aval.Text;
            if (radDx_sexo1.Checked)
            {
                creditoLog.Fg_Sexo_Aval = "1";
            }
            else if (radDx_sexo2.Checked)
            {
                creditoLog.Fg_Sexo_Aval = "2";
            }
            creditoLog.Dx_Domicilio_Aval_Calle = txtDx_domicilio_aval_calle.Text;
            creditoLog.Dx_Domicilio_Aval_Num = txtDx_domicilio_aval_num.Text;
            creditoLog.Dx_Domicilio_Aval_CP = txtDx_domicilio_aval_cp.Text;
            creditoLog.Cve_Estado_Aval = ddlDx_nombre_estado_aval.SelectedValue;
            creditoLog.Cve_Deleg_Municipio_Aval = ddlDx_deleg_municipio_aval.SelectedValue;
            creditoLog.Dx_Domicilio_Aval_Colonia = txtDx_Domicilio_Aval_Colonia.Text;

            creditoLog.Cve_Sector = Convert.ToInt32(ddlDX_SECTOR_ECONOMICO.SelectedValue);
            creditoLog.No_Empleados = Convert.ToInt32(txtNO_EMPLEADOS.Text);
            creditoLog.User_Name = UserId;
        ...
        private EntidadCredito GetDataFromStepOne()
        {
            EntidadCredito creditModel = new EntidadCredito();
            ...
            creditModel.Cve_Tipo_Industria = (ddlDX_TIPO_INDUSTRIA.SelectedIndex != 0 && ddlDX_TIPO_INDUSTRIA.SelectedIndex != -1) ? Convert.ToInt32(ddlDX_TIPO_INDUSTRIA.SelectedValue) : 0;
            creditModel.Cve_Tipo_Sociedad = (ddlDX_TIPO_SOCIEDAD.SelectedIndex != 0 && ddlDX_TIPO_SOCIEDAD.SelectedIndex != -1) ? Convert.ToInt32(ddlDX_TIPO_SOCIEDAD.SelectedValue) : 0;
            ...
            creditModel.Cve_Acreditacion_Repre_legal = (ddlDX_ACREDITACION_REPRE_LEGAL.SelectedIndex != 0 && ddlDX_ACREDITACION_REPRE_LEGAL.SelectedIndex != -1) ? Convert.ToInt32(ddlDX_ACREDITACION_REPRE_LEGAL.SelectedValue) : 0;
            ...
            creditModel.Cve_Reg_Conyugal_Repre_legal = (ddlDX_REG_CONYUGAL_REPRE_LEGAL.SelectedIndex != 0 && ddlDX_REG_CONYUGAL_REPRE_LEGAL.SelectedIndex != -1) ? Convert.ToInt32(ddlDX_REG_CONYUGAL_REPRE_LEGAL.SelectedValue) : 0;
            creditModel.Cve_Identificacion_Repre_legal = (ddlDX_IDENTIFICACION_REPRE_LEGAL.SelectedIndex != 0 && ddlDX_IDENTIFICACION_REPRE_LEGAL.SelectedIndex != -1) ? Convert.ToInt32(ddlDX_IDENTIFICACION_REPRE_LEGAL.SelectedValue) : 0;
            creditModel.Dx_No_Identificacion_Repre_Legal = txtDX_NO_IDENTIFICACION_REPRE_LEGAL.Text;
            creditModel.Mt_Ventas_Mes_Empresa = (!string.IsNullOrEmpty(txtMT_VENTAS_MES_EMPRESA.Text)) ? Convert.ToDouble(txtMT_VENTAS_MES_EMPRESA.Text) : default(double);
            creditModel.Mt_Gastos_Mes_Empresa = (!string.IsNullOrEmpty(txtMT_GASTOS_MES_EMPRESA.Text)) ? Convert.ToDouble(txtMT_GASTOS_MES_EMPRESA.Text) : default(double);
            ...
            //DOMICILIO FISCAL   //
            creditModel.Dx_Domicilio_Fisc_Calle = txtDx_Domicilio_fisc_calle.Text;
            ...
            //creditModel.Mt_Ventas_Mes_Aval = (!string.IsNullOrEmpty(txtMt_ventas_mes_aval.Text)) ? Convert.ToDouble(txtMt_ventas_mes_aval.Text) : default(double);// txtMt_ventas_mes_aval.Text;
            //creditModel.Mt_Gastos_Mes_Aval = (!string.IsNullOrEmpty(txtMt_gastos_mes_aval.Text)) ? Convert.ToDouble(txtMt_gastos_mes_aval.Text) : default(double);// txtMt_gastos_mes_aval.Text;
            ...
            creditModel.Cve_Sector_economico = Convert.ToInt32(ddlDX_SECTOR_ECONOMICO.SelectedValue);
            creditModel.No_Empleados = Convert.ToInt32(txtNO_EMPLEADOS.Text);
        ...
        private void AccountTotal()
        {
            ...
            for (int i = 0; i < gvTecPro.Rows.Count; i++)
            {
                ...
                {
                    deTotal = (decimal)TwoDecimals(double.Parse(hfExactSubtotal.Value) * (1 + PctTasaIva / 100));  // +IVA
                ...
                {
                    gastosTotal += (decimal)TwoDecimals(double.Parse(txtGastos.Text) * (1 + PctTasaIva / 100));  // +IVA
                }
            }
            ...
            else
            {
                ...
                AcountTotal = (AcountTotal + gastosTotal) / (1+ Convert.ToDecimal(PctTasaIva) / 100);
                ...
                */
                ...
                txtSubTotal.Text = TwoDecimals((double)AcountTotal).ToString("c");
                txtTotalCost.Text = CreditCostEntity.Mt_Costo.ToString("c");
                txtTotalDescount.Text = CreditDesEntity.Mt_Descuento.ToString("c");
                ...
                txtTotal.Text = (AcountTotal + AcountTotal * Convert.ToDecimal(PctTasaIva) / 100 - (CreditDesEntity.Mt_Descuento - CreditCostEntity.Mt_Costo)).ToString("c");
                Session["monto_solicitado"] = Math.Round(AcountTotal + AcountTotal * Convert.ToDecimal(PctTasaIva) / 100 - (CreditDesEntity.Mt_Descuento - CreditCostEntity.Mt_Costo), 2);
                // FRR 20130923 Negative discount
        ...
        private void GetPctTasaIVA()
        {
            if (TipoUser == GlobalVar.SUPPLIER)
            {
                ...
                PctTasaIva = float.Parse(ProModel.Pct_Tasa_IVA.ToString());
            }
            else if (TipoUser == GlobalVar.SUPPLIER_BRANCH)
            {
                if (Session["UserInfo"] != null)
                {
                    ...
                    if (dtSupplierBranch != null && dtSupplierBranch.Rows.Count > 0)
                    {
                        PctTasaIva = float.Parse(dtSupplierBranch.Rows[0]["Pct_Tasa_IVA"].ToString());
                    }
                }
            }
        }
        ...
        //private void ValidacionPyme(WizardNavigationEventArgs e)
        //{
        ...
        //        SolicitudCreditoAcciones.GuarDatosPyme(datosPyme);

        //        if (!esPyme)
        //        {
        //            var strMsg = "Su Empresa no cumple con las características de una Pyme";
        //            ScriptManager.RegisterClientScriptBlock(panel, typeof(Page), "NextError", "alert('" + strMsg + "');", true);
        //            e.Cancel = true;
        //            return;
        //        }
        ...
        protected void btn41_Click(object sender, EventArgs e)
        {
            if (TipoSociedad != (int)CompanyType.PERSONAFISICA
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "PrintForm", "window.open('PrintForm.aspx?ReportName=AutorizacionConsultaBuroPM&CreditNumber=" + CreditNo + "','','top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=no');", true);
            else
                ScriptManager.RegisterStartupScript(this, GetType(), "PrintForm", "window.open('PrintForm.aspx?ReportName=AutorizacionConsulta Buro&CreditNumber=" + CreditNo + "','','top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=no');", true);

        }

        protected void btn42_Click(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "PrintForm", "window.open('PrintForm.aspx?ReportName=Presupuesto de Inversion&CreditNumber=" + CreditNo + "','','top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=no');", true);
        }

        protected void btn43_Click(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "PrintForm", "window.open('PrintForm.aspx?ReportName=Tabla de Amortizacion&CreditNumber=" + CreditNo + "','','top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=no');", true);
        }
        protected void btnDisplayRequest_Click(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "PrintForm", "window.open('PrintForm.aspx?ReportName=Solicitud de Credito&CreditNumber=" + CreditNo + "','','top=0,left=0,toolbar=no,menubar=no,scrollbars=yes, resizable=yes,location=no, status=no');", true);
        }
        #endregion
