<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="ValidateCrediticialHistory.aspx.cs"
    Inherits="PAEEEM.ValidateCrediticialHistory" Title="Validación de Historial de Crédito" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:Wizard ID="wizardPages" runat="server" Style="width: 100%;" DisplaySideBar="false"
                    ...
                    <WizardSteps>
                        <asp:WizardStep runat="server" ID="Validate" StepType="Start" Title="Validate Crediticial History">
                            <table width="100%">
                                <tr>
