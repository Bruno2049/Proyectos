<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapturaDatosSolicitud.aspx.cs" Inherits="PAEEEM.SupplierModule.CapturaDatosSolicitud" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidaRFC() {
            if (confirm('El RFC no corresponde con los Datos ¿Deseas enviar a validación?'))
            {
            ...
            {
                alert('No enviar a validacion');
            }
        }

        function EnviaNotificacion() {
            alert(' El RFC fue enviado a validacion');
        ...
        function ValidarEdad(cfecha, v) {
            if (cfecha == v)
                cfecha = document.getElementById(pre + v).value;
            var annio = cfecha.substring(0, 4);
            var mes = cfecha.substring(5, 7);
            var dia = cfecha.substring(8, 10);

            var fechaActual = new Date();
            var fechaTexto = dia + "-" + mes + "-" + annio;
            var fechaCapturada = new Date(fechaTexto);
            if (fechaCapturada > fechaActual)
                alert("La fecha seleccionada debe ser menor a la fecha actual");
            else {
                var edad = calcular_edad(fechaTexto);

                if (edad < 18 || edad >= 66) {
                    document.getElementById(pre + v).value = "";
                    alert("La edad del cliente no cumple con los requisitos.");
                } else {
                    var fechaFormato = cfecha;
        ...
        function muestra_calendario(v, validaEdad) {
            ...
            if (cfecha == -1 || cfecha == null || cfecha == "")
                ...
                if (fechaCapturada > fechaActual)
                    alert("La fecha seleccionada debe ser menor a la fecha actual");
                else if (validaEdad == 1) {
                    ValidarEdad(annio + "-" + mes + "-" + dia, v);
                } else {
                    var fechaFormato = annio + "-" + mes + "-" + dia;
                    document.getElementById(pre + v).value = fechaFormato;
                }
            }
        }
        ...
        function lockScreen() {
            ...
            lock.style.top = document.body.offsetHeight / lock.style.height.replace('px', '') + 'px';
        ...
        function confirmCallBackFn2(arg) {
            if (arg == true) {
                var oButton = document.getElementById(pre + "HiddenButton2");
                oButton.click();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <asp:Wizard ID="wizardPages" runat="server" DisplaySideBar="false" Style="width: auto"
                ...
                <WizardSteps>
                                    ...
                                    <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td class="auto-style2" style="vertical-align: top;">
                                                ...
                                                <asp:TextBox ID="TxtFechaNacimientoVPyME" runat="server" onchange="ValidarEdad('TxtFechaNacimientoVPyME','TxtFechaNacimientoVPyME')" Width="230px" />
                                                <img id="Img2" onclick="muestra_calendario('TxtFechaNacimientoVPyME',1)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;</img>&nbsp;</img>&nbsp;</img></img>&nbsp;&nbsp;</img><asp:RequiredFieldValidator runat="server"
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td class="auto-style2" style="vertical-align: top;">
                                                ...
                                                <img id="Img3" onclick="muestra_calendario('TxtFechaConstitucionVPyME',0)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;</img>&nbsp;</img>&nbsp;</img></img>&nbsp;&nbsp;</img><asp:RequiredFieldValidator runat="server"
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td class="auto-style2" style="vertical-align: top;">
                                            ...
                                            <asp:TextBox ID="TxtCP" runat="server" Width="250px" AutoPostBack="True" OnTextChanged="TxtCP_TextChanged" onChange="lockScreen();" MaxLength="5" />
                                            <asp:RequiredFieldValidator runat="server"
                                        ...
                                        <td class="auto-style2" style="vertical-align: top;">
                                            ...
                                            <asp:DropDownList ID="DDXEstado" runat="server" AutoPostBack="True" Width="250px" OnSelectedIndexChanged="DDXEstado_SelectedIndexChanged" onChange="lockScreen();"/>
                                            <asp:RequiredFieldValidator runat="server"
                                        ...
                                        <td class="auto-style2" style="vertical-align: top;">
                                            ...
                                            <asp:DropDownList ID="DDXMunicipio" Width="250px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDXMunicipio_SelectedIndexChanged" onChange="lockScreen();"/>
                                            <asp:RequiredFieldValidator runat="server"
                                    ...
                                    <tr>
                                        <td class="auto-style2" style="vertical-align: top;">
                                            ...
                                            <asp:DropDownList ID="DDXColonia" Width="250px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDXColonia_SelectedIndexChanged" onChange="lockScreen();" />
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 290px; vertical-align: top;">
                                            ...
                                            <asp:TextBox ID="TxtCPFiscalCBas" runat="server" Width="250px" MaxLength="5" AutoPostBack="True" OnTextChanged="TxtCPFiscalCBas_TextChanged" onChange="lockScreen();" />
                                            <asp:RequiredFieldValidator runat="server"
                                        ...
                                        <td style="width: 290px; vertical-align: top;">
                                            ...
                                            <asp:DropDownList ID="DDXEstadoFiscalCBas" runat="server" Width="250px" OnSelectedIndexChanged="DDXEstadoFiscalCBas_SelectedIndexChanged" AutoPostBack="True" onChange="lockScreen();"/>
                                            <asp:RequiredFieldValidator runat="server"
                                        ...
                                        <td style="width: 290px; vertical-align: top;">
                                            ...
                                            <asp:DropDownList ID="DDXMunicipioFiscalCBas" Width="250px" runat="server" OnSelectedIndexChanged="DDXMunicipioFiscalCBas_SelectedIndexChanged" AutoPostBack="True" onChange="lockScreen();"/>
                                            <asp:RequiredFieldValidator runat="server"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:DropDownList ID="DDXColoniaFiscalCBas" Width="250px" runat="server" OnSelectedIndexChanged="DDXColoniaFiscalCBas_SelectedIndexChanged" AutoPostBack="True" onChange="lockScreen();"/>
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 290px; vertical-align: top;">Fecha:<br />
                                                ...
                                                <img id="Img8" onclick="muestra_calendario('TxtPNCliente',0)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator runat="server"
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            ...
                                            <td style="width: 290px; vertical-align: top;">Fecha:<br />
                                                ...
                                                <img id="Img4" onclick="muestra_calendario('TxtFechaClienteAC',0)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator runat="server"
                                    ...
                                    <table style="width: 873px;">
                                        ...
                                        <tr>
                                            ...
                                            <td>Fecha de Nacimiento:
                                                <asp:TextBox ID="TxtFechaNacimietoOS" onchange="ValidarEdad('TxtFechaNacimietoOS','TxtFechaNacimietoOS')" runat="server" Width="250px" />
                                                <img id="Img5" onclick="muestra_calendario('TxtFechaNacimietoOS',1)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator runat="server"
                                        ...
                                        <tr>
                                            <td class="auto-style2" style="vertical-align: top;">Código Postal:
                                                <asp:TextBox ID="TxtCPOS" runat="server" Width="250px" MaxLength="5" OnTextChanged="TxtCPOS_TextChanged" AutoPostBack="True" onChange="lockScreen();"/>
                                                <asp:RequiredFieldValidator runat="server"
                                            ...
                                            <td class="auto-style2" style="vertical-align: top;">Estado:
                                                <asp:DropDownList ID="DDXEstadoOS" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="DDXEstadoOS_SelectedIndexChanged" onChange="lockScreen();"/>
                                                <asp:RequiredFieldValidator runat="server"
                                            ...
                                            <td class="auto-style2" style="vertical-align: top;">Delegación o Municipio:
                                                <asp:DropDownList ID="DDXMunicipioOS" Width="250px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDXMunicipioOS_SelectedIndexChanged" onChange="lockScreen();"/>
                                                <asp:RequiredFieldValidator runat="server"
                                        ...
                                        <tr>
                                            <td class="auto-style2" style="vertical-align: top;">Colonia:
                                                <asp:DropDownList ID="DDXColoniaOS" Width="250px" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDXColoniaOS_SelectedIndexChanged" onChange="lockScreen();"/>
                                            ...
                                            <td class="auto-style2" style="vertical-align: top; width: 250px;">
                                                <asp:Label ID="Label2" runat="server" Text=" Calle:" Width="250px" />
                                    ...
                                    <table style="width: 873px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2" style="vertical-align: top;">Fecha:<br />
                                                ...
                                                <img id="Img6" onclick="muestra_calendario('TxtFechaEscrituraPN',0)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator runat="server"
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style2" style="vertical-align: top;">Fecha:<br />
                                                ...
                                                <img id="Img7" onclick="muestra_calendario('TxtFechaAC',0)" runat="server" src="~/CentralModule/images/Calendario.bmp" style="width: 17px; height: 17px" alt="" />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RequiredFieldValidator runat="server"
                    ...
                    <asp:WizardStep runat="server" ID="wizBajaEquiposCapturaComp" StepType="Step">
                        ...
                        <div id="divGridEquiposBaja" style=" width: 100%; height: 400px; align-content: center; overflow:scroll" align="center" runat="server">
                            <asp:GridView Width="100%" runat="server" ID="grdEquiposBaja" AutoGenerateColumns="False" CssClass="GridViewStyle"
                                AllowPaging="False"  DataKeyNames="Id_Credito_Sustitucion"
                    ...
                    <asp:WizardStep runat="server" ID="wizardAltaBajaEquipos" StepType="Finish">
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 180px; height: 25px">
                                    <asp:Label ID="Label3" runat="server" CssClass="Label,etiqueta" Text="Nombre comercial" />
                                </td>
                                <td style="width: 200px; height: 25px;">
                                    <asp:TextBox ID="txtRazonSocialAltaEquipos" runat="server" CssClass="TextBox" Enabled="False" Font-Size="11px" Width="200px" />
                                </td>
                                <td style="width: 150px; height: 25px;">
                                    <asp:Label ID="Label5" runat="server" CssClass="Label,etiqueta" Text="Número Crédito" />
                                </td>
                                <td style="height: 25px">
                        ...
                        <table>
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label53" runat="server" CssClass="Label,etiqueta" Text="Fotografía Fachada del Negocio/Local: " />
                                </td>
                        ...
                        <br />
                        <div id="div4" style=" width: 100%; height: 400px; align-content: center; overflow:scroll" runat="server">
                            <asp:GridView Width="100%" runat="server" ID="grdEquiposAlta" AutoGenerateColumns="False" CssClass="GridViewStyle"
                                AllowPaging="False"  DataKeyNames="Id_Credito_Producto,idConsecutivo" OnRowDataBound="grdEquiposAlta_RowDataBound">
                                <FooterStyle CssClass="GridViewFooterStyle" />
                                <RowStyle CssClass="GridViewRowStyle" />
                                <HeaderStyle CssClass="GridViewHeaderStyleNet" />
                                 <PagerSettings Visible="false" />
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td colspan="8">
                                        ...
                                        <asp:Label runat="server" Text="Información Equipo Alta" CssClass="Label1" ForeColor="#333333" ID="Label54" />
                                    </td>
                                </tr>
                            </table>
                            <br />
                                    ...
                                    <table>
                                        <tr>
                                            <td colspan="2" class="auto-style10">
                                                <asp:Label ID="Label61" runat="server" CssClass="Label,etiqueta" Text="Fotografía Equipo Viejo: " />
                                            </td>
                                            <td colspan="2" style="width: 280px">
                            ...
                            <asp:Panel ID="EquipoNuevo" runat="server">
                                <fieldset class="legend_info">
                                    ...
                                    <table>
                                        <tr>
                                            <td colspan="2" class="auto-style10">
                                                <asp:Label ID="Label62" runat="server" CssClass="Label,etiqueta" Text="Fotografía Equipo Nuevo: " />
                                            </td>
                                            <td colspan="2" style="width: 280px">
    ...
    <telerik:RadWindowManager ID="RadWindowManager2" runat="server" EnableShadow="true" Width="500px" Height="300px"></telerik:RadWindowManager>
        <telerik:RadWindow ID="RadWindow1" runat="server" Width="650px" Height="500px" Modal="true">
            <ContentTemplate>
                <div style="padding: 10px; text-align: center; align-content: center; width: inherit; height: inherit;">
                    <table style="text-align:center; width:500px;">
                        <tr>
                            <td>
                                <asp:Image ID="Image7" runat="server" ImageUrl="images/Alert.jpg" Width="50px" Height="50px"/>
                            </td>
                            <td>
                                <asp:Label ID="Label64" runat="server" Text="Para enviar a validar el RFC, deberá cargar la carta del SAT que el "></asp:Label>
                                <asp:Label ID="Label65" runat="server" Text="cliente le ha entregado y seleccionar el botón Enviar a Validación"></asp:Label>
                                <br />
                            </td>
                            <td>
                                <asp:Image ID="Image10"  runat="server" ImageUrl="images/Alert.jpg" Width="50px" Height="50px"/>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <br />
                                “Nota: Después de que la zona haya validado su RFC, recibirá un correo indicando si su solicitud fue aprobada, en caso exitoso deberá proceder con la captura de la solicitud.”
                                <br />
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td >
                                ...
                                <asp:FileUpload ID="UPL_PDF" runat="server"/>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
