<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoadQuery.aspx.cs" Inherits="PAEEEM.CentralModule.LoadQuery" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" Skin="Default" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="RadPanel_OnRequestStart">
        <table id="tblBase" class="dvMainPanel">
            <tr>
                <td colspan="4">
                    <h2>
                        <asp:Label ID="lblTitulo" runat="server" Font-Size="Large" Font-Bold="True" Text="Carga consultas"></asp:Label>
                    </h2>
                    <hr class="rule" />
                </td>
            </tr>
                        ...
                        <table class="dvMainPanel">
                            ...
                            <tr>
                                <td colspan="5" style="text-align: right">
                                    <telerik:RadButton ID="btnAgregar" runat="server" OnClick="btnAgregar_Click" Text="Nuevo">
                                        <%--<Image ImageUrl="images/editar-icono.png" />--%>
                                    </telerik:RadButton>
                                    <telerik:RadButton ID="btnAceptar" runat="server" OnClick="btnAceptar_Click" Text="Aceptar">
                                        <%--<Image ImageUrl="../images/Aceptar.png" />--%>
                                    </telerik:RadButton>
                                    <telerik:RadButton ID="btnCancelar" runat="server" OnClick="btnCancelar_Click" Text="Cancelar">
                                        <%--<Image ImageUrl="../../images/Cancelar.png" />--%>
                                    </telerik:RadButton>
                                </td>
                            </tr>
                        </table>
                    ...
                    <asp:GridView ID="grdQuery" runat="server" AutoGenerateColumns="False" CssClass="GridViewStyle" OnRowCommand="grdQuery_RowCommand" OnRowEditing="grdQuery_RowEditing">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Consulta" SortExpression="Nombre_Consulta">
                                <ItemTemplate>
                                    <asp:Label ID="lblConsulta" runat="server" Text='<%# Bind("Nombre_Consulta") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="20%" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Descripción" SortExpression="Descripcion_Consulta">
                                <ItemTemplate>
                                    <asp:Label ID="lblDescripcion" runat="server" Text='<%# Bind("Descripcion_Consulta") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="70%" />
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <div style="width: 100px; border-spacing: 10px">
                                        <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="Edit" ImageUrl="~/images/Edit.gif" Text="Edit" />
                                        <asp:ImageButton ID="btnDelete" runat="server" CausesValidation="false" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="Borrar" ImageUrl="~/CentralModule/images/eliminar-icono.png" Text="Delete" />
