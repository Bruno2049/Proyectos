...
namespace PAEEEM.DataAccessLayer
{
    ...
    public class US_NAVEGACIONDal
    {
        ...
        // Netropology - agregar permisos de usuario a permisos de rol
        public DataTable ObtenNavegacionRolUsuario(int roleID, int userId,string rootValue)
        {
            try
            {
                string SQL = "SELECT TOP 1000 [Id_Rol],[Nombre_Rol],[Nombre_Navegacion],[Url_Navegacion],[Codigo_Padres],[Ruta_Padres],[Secuencia],[Nivel_Navegacion],Id_Navegacion,Id_Permiso FROM [dbo].[View_Role_Navigation] WHERE Codigo_Padres =@RootValue AND [Id_Rol]=@RoleID ";
                SQL = SQL + " AND Id_Permiso NOT IN (SELECT Id_Permiso FROM US_USUARIO_PERMISO WHERE Id_Usuario = @UserID)";
                SQL = SQL + " UNION ALL ";
                SQL = SQL + " select [Id_Rol],[Nombre_Rol],[Nombre_Navegacion],[Url_Navegacion],[Codigo_Padres],[Ruta_Padres],[Secuencia],[Nivel_Navegacion],Id_Navegacion,Id_Permiso from [dbo].[View_User_Navigation]  where Codigo_Padres =@RootValue AND ID_USUARIO = @UserID";
        ...
        public string ObtenURLNavegacion(int roleID, int userId,string rootValue)
        {
            try
            {
                string SQL = "SELECT TOP 1 [Url_Navegacion]  FROM [dbo].[View_Role_Navigation] WHERE Id_Navegacion =@RootValue AND [Id_Rol]=@RoleID ";
                SQL = SQL + " UNION ALL ";
                SQL = SQL + " SELECT TOP 1 [Url_Navegacion]  FROM [dbo].[View_User_Navigation] WHERE Id_Navegacion =@RootValue AND [Id_Usuario]=@UserID ";
