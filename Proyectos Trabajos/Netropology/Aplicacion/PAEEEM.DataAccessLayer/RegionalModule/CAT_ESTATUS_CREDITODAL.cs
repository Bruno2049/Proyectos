...
namespace PAEEEM.DataAccessLayer
{
    ...
    public class CAT_ESTATUS_CREDITODal
    {
        ...
        private CAT_ESTATUS_CREDITOModel EvaluateModel(SqlDataReader sdr)
        {
            try
            {
                var modelinstance = new CAT_ESTATUS_CREDITOModel();
                modelinstance.Cve_Estatus_Credito = sdr.IsDBNull(sdr.GetOrdinal("Cve_Estatus_Credito")) ? 0 : sdr.GetOrdinal("Cve_Estatus_Credito");
