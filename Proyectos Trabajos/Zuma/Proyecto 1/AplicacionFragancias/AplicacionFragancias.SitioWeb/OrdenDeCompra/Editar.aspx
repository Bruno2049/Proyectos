                ...
                <asp:GridView ID="gvProductos" runat="server" AutoGenerateColumns="False" DataKeyNames="IDPRODUCTOS,NOORDENCOMPRA" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto Entregado" SortExpression="Description">
                            <EditItemTemplate>
                                <asp:CheckBox ID="chbEntregadoE" runat="server" Checked='<%# Convert.ToBoolean(Eval("ENTREGADO")) %>' ></asp:CheckBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:CheckBox ID="chbEntregadoB" runat="server" Checked='<%# Convert.ToBoolean(Eval("ENTREGADO")) %>'></asp:CheckBox>
                            </ItemTemplate>
                        </asp:TemplateField>
