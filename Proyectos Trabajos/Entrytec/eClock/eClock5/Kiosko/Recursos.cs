...
namespace Kiosko
{
    class Recursos
    {
        ...
        public static Double FontSizeSubTitle = 0;
        public static Double FontSizeTitle = 0;
        ...
        public static bool Inicia(System.Windows.Window Ventana)
        {
            ...
            FontSizeSubTitle = (Double)Ventana.FindResource("FontSizeSubTitle");
            FontSizeTitle = (Double)Ventana.FindResource("FontSizeTitle");
