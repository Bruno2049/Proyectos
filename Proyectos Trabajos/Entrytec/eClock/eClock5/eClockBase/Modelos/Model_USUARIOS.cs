...
namespace eClockBase.Modelos
{
    public class Model_USUARIOS
    {
        ...
        [Campo_String(true, false, 45, "", Campo_StringAttribute.Tipo.TextBoxPassword)]
        ...
        [Campo_Int(false, false, -1, -1, 0, Campo_IntAttribute.Tipo.PersonaLinkID)]
        public int PERSONA_ID { get; set; }
        //Si es positivo indica que este usuario esta dado de baja (borrado)
        [JsonConverter(typeof(BoolConverter))]
        [Campo_Bool(false, false, false, Campo_BoolAttribute.Tipo.CheckBox)]
        public bool USUARIO_BORRADO { get; set; }
