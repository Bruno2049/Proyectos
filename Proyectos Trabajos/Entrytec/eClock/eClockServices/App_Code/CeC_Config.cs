...
public class CeC_Config
{
    ...
    /// </summary>
    public static string HashQuery_IniciaBase
    {
        get { return ObtenConfig(0, "HashQuery_IniciaBase", ""); }
        set { GuardaConfig(0, "HashQuery_IniciaBase", value); }
    }
    ...
    /// para verificar si este a cambiado y se debe ejecutar nuevamente todo el archivo de script
    /// </summary>
    public static string HashQuery_IniciaBaseActualizacion
    {
        get { return ObtenConfig(0, "HashQuery_IniciaBaseActualizacion", ""); }
        set { GuardaConfig(0, "HashQuery_IniciaBaseActualizacion", value); }
    }
    ...
    /// para verificar si este a cambiado y se debe ejecutar nuevamente todo el archivo de script
    /// </summary>
    public static string HashQuery_IniciaBaseVistas
    {
        get { return ObtenConfig(0, "HashQuery_IniciaBaseVistas", ""); }
        set { GuardaConfig(0, "HashQuery_IniciaBaseVistas", value); }
    }

    public static string HashQuery_IniciaBaseRestricciones
    {
        get { return ObtenConfig(0, "HashQuery_IniciaBaseRestricciones", ""); }
        set { GuardaConfig(0, "HashQuery_IniciaBaseRestricciones", value); }
    }

    public static string HashQuery_IniciaBaseActPDIDS
    {
        get { return ObtenConfig(0, "HashQuery_IniciaBaseActPDIDS", ""); }
        set { GuardaConfig(0, "HashQuery_IniciaBaseActPDIDS", value); }
    }
    ...
    public static string RutaReportesLogs
    {
        get { return ObtenConfig(0, "RutaReportesLogs", "Logs/"); }
        set { GuardaConfig(0, "RutaReportesLogs", value); }
    }
    ...
    /// <summary>
    /// Obtiene o establece el la hora de inicio en la que se hará 
    /// la sincronización de huellas con la terminal por default tomara 
    /// la fecha del sistema
    /// </summary>
    public static DateTime SyncH_HoraInicio
    {
        get
        {
            string Hora = CeC_BD.ObtenParamTerminal(0, "SyncH_HoraInicio", "09:15");
            DateTime FechaHora = Convert.ToDateTime(Hora);
            return FechaHora;
        }
        set
        {
            string Hora = value.ToString("t");
            CeC_BD.GuardaParamTerminal(0, "SyncH_HoraInicio", Hora);
        }
    }

    /// <summary>
    /// Obtiene o establece el la hora de fin en la que se hará 
    /// la sincronización de huellas con la terminal por default tomara 
    /// la fecha del sistema
    /// </summary>
    public static DateTime SyncH_HoraFin
    {
        get
        {
            string Hora = CeC_BD.ObtenParamTerminal(0, "SyncH_HoraFin", "11:15");
            DateTime FechaHora = Convert.ToDateTime(Hora);
            return FechaHora;
        }
        set
        {
            string Hora = value.ToString("t");
            CeC_BD.GuardaParamTerminal(0, "SyncH_HoraFin", Hora);
        }
    }
    /// <summary>
    /// Obtiene la fehca de sincroniozacion de la huella en la Hora de inicio y final
    /// </summary>
    public static bool SyncHuella_Ahora
    {
        get
        {
            if (SyncH_HoraInicio > DateTime.Now)
                return false;
            if (SyncH_HoraFin < DateTime.Now)
                return false;
            return true;
        }
    ...
    public static string LinkeClock
    {
        ...
        get { return ObtenConfig(0, "LinkeClock", "http://www.eclock.com.mx/"); }
        set { GuardaConfig(0, "LinkeClock", value); }

    }
    public static string LinkeClockComprar
    {

        get { return ObtenConfig(0, "LinkeClockComprar", "http://www.eclock.com.mx/"); }
        set { GuardaConfig(0, "LinkeClockComprar", value); }

    }
    public static string LinkeClockComentarios
    {

        get { return ObtenConfig(0, "LinkeClockComentarios", "http://www.eclock.com.mx/"); }
        set { GuardaConfig(0, "LinkeClockComentarios", value); }
    ...
    /// <summary>
    /// Envia una alerta de los supervisores que obtuvieron retardos.
    /// </summary>
    /// <param name=""></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Envia una alerta de los empleados que obtuvieron retardos.
    /// </summary>
    /// <param name=""></param>
    /// <returns></returns>
    ...
    {
        get { return ObtenConfig(USUARIO_ID, "EnviarMailSolicitudIncidencia", true); }
    ...
    public static int TramiteResumenUltimoTramiteID
    {
        get { return ObtenConfig(0, "TramiteResumenUltimoTramiteID", 0); }
        set { GuardaConfig(0, "TramiteResumenUltimoTramiteID", value); }
    }

    public static int ActividadResumenUltimoIncripActID
    {
        get { return ObtenConfig(0, "ActividadResumenUltimoIncripActID", 0); }
        set { GuardaConfig(0, "ActividadResumenUltimoIncripActID", value); }
    }

    public static int IncidenciasResumenUltimoIncidenciaID
    {
        get { return ObtenConfig(0, "IncidenciasResumenUltimoIncidenciaID", 0); }
        set { GuardaConfig(0, "IncidenciasResumenUltimoIncidenciaID", value); }
    }
