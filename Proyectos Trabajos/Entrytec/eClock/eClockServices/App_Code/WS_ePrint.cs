...
namespace eClock
{
    ...
    public class WS_ePrint : System.Web.Services.WebService
    {
                    ...
                    case "System.Byte[]":
                        ...
                        if (((Array)Campos[i].Valor).Length > 1)
                        {
                            ...
                            if (Campos[i].NombreCampo == "FOTOGRAFIA")
                                CeC_Personas.AsignaFoto(_PersonaID, _ArregloBytes,null);
                            if (Campos[i].NombreCampo == "FIRMA")
                                CeC_Personas.AsignaFirma(_PersonaID, _ArregloBytes, null);
                        }
                        else
                        {
                            if (Campos[i].NombreCampo == "FOTOGRAFIA")
        ...
        public bool InsertaRegistroEmpleado(DS_ePrint.DT_CamposModDataTable Campos, string NombreTabla, string CampoLlave)
        {
            ...
            if (_ret > 0)
            {
                ...
                */
                ...
                if (_TieneFoto)
                    CeC_Personas.AsignaFoto(Persona_ID, _ArregloBytesFoto, null);
                if (_TieneFirma)
                    CeC_Personas.AsignaFirma(Persona_ID, _ArregloBytesFirma, null);
                return true;
            }
            return false;
        }
        ...
        public bool ActualizarFoto(byte[] Foto, string ValorCampoLlave)
        {
            ...
            return CeC_Personas.AsignaFoto(PersonaID, Foto, null);
        }
