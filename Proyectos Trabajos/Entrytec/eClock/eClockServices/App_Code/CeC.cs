...
public class CeC
{
    ...
    public static string ObtenValorJson(string ValoresJson, string Parametro, string ValorPredeterminado)
    {
        Parametro = Parametro + "\"";
        string[] Valores = ObtenArregoSeparador(ValoresJson, "\",\"");
        foreach (string Valor in Valores)
        {
            if (Valor.IndexOf(Parametro) >= 0)
            {
                string ValorR = ObtenColumnaSeparador(Valor, "\":\"", 1);
    ...
    {
        return Convierte2DateTime(Valor, CeC_BD.FechaNula);
    }
    ...
    public static TimeSpan Convierte2TimeSpan(object Valor)
    {
        return Convierte2TimeSpan(Valor, new TimeSpan());
    }


    public static TimeSpan Convierte2TimeSpan(object Valor, TimeSpan Predeterminado)
    {
        try
        {
    ...
    public static string Bcd2String(byte[] Arreglo)
    {
        return Bcd2String(Arreglo, 0, Arreglo.Length);
    }
    /// <summary>
