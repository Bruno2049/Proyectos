<%@ Page language="c#"  CodeFile="WF_ExportarIncidenciasAdam.aspx.cs" AutoEventWireup="True" Inherits="WF_ExportarIncidenciasAdam" %>
...
<body style="font-size: 11px; font-family: tahoma; text-align: center; margin: 0px; ">
    ...
    <igmisc:WebPanel ID="WebPanel2" runat="server" EnableAppStyling="True" 
            Height="385px" StyleSetName="Caribbean" Width="100%" >
        <Header Text="Exportación de incidencias Adam" >
        ...
        <Template>
            <table style="width: 100%; height: 367px;">
                <tr>
                    <td colspan="2">
                        Elija el Tipo de nomina y periodo</td>
                </tr>
                <tr>
                    <td class="style3" colspan="2">
                        <igtbl:UltraWebGrid ID="Grid" runat="server" Height="273px" 
                ...
                <tr>
                    <td class="style2">
                        <igtxt:WebImageButton ID="Btn_Actualizar" runat="server" Height="22px" 
                            ImageTextSpacing="4" OnClick="Btn_Actualizar_Click" Text="Actualizar" 
                    ...
                    <td class="style2">
                        <igtxt:WebImageButton ID="BGuardarCambios" runat="server" Height="22px" 
                            ImageTextSpacing="4" OnClick="BGuardarCambios_Click" Text="Enviar Incidencias" 
