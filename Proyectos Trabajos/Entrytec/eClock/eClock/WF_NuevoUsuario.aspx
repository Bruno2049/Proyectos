<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_NuevoUsuario.aspx.cs" Inherits="WF_NuevoUsuario" MasterPageFile="MasterPage3.master" %>
            ...
            <td colspan="2" style="text-align: left">
                <div class="C03_DarkDenim_TitleLine">
                    <div class="C03_Denim_DarkTitle">
                        <span id="dnn_ctr_dnnTITLE_lblTitle" class="style1">Solicitar Acceso a eClock</span></div>
                </div>
                <br />
                Si usted desea adquirir una licencia de uso para su empresa de click aqui
                <asp:HyperLink ID="HyperLink8" runat="server">Comprar</comprar></asp:HyperLink>
                <br />
                <br />
                Si usted es colaborador de alguna empresa que usa eClock y le dieron acceso al 
                portar, entonces llene los siguientes datos</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
