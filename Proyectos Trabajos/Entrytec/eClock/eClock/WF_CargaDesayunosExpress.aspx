<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WF_CargaDesayunosExpress.aspx.cs" Inherits="WF_CargaDesayunosExpress" %>
...
<CalendarStyle Font-Italic="False" Font-Strikeout="False" Font-Underline="False" Font-Overline="False" Font-Bold="False"></CalendarStyle>
    ...
    <igtbl:UltraWebGrid Style="left: 360px; float: left; top: 0px" ID="CopyPasteGrid1"
                    ...
                    <DisplayLayout Version="4.00" SelectTypeCellDefault="Extended" AllowColSizingDefault="Free"
                        AllowUpdateDefault="Yes" Name="CopyPasteGrid1" BorderCollapseDefault="Separate"
                        ...
                        <ClientSideEvents ClipboardError="Grid_OnClipboardError" MouseUpHandler="GridClick">
                        </ClientSideEvents>
        ...
        <tr>
            <td colspan="2">
                <igtxt:WebImageButton ID="BGuardarCambios" runat="server" Height="22px" OnClick="BGuardarCambiosM_Click"
                    Text="Guardar y Agregar Mas" UseBrowserDefaults="False" Width="210px" ImageTextSpacing="4">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp;
                <igtxt:WebImageButton ID="Webimagebutton1" runat="server" Height="22px" OnClick="BGuardarCambios_Click"
                    Text="Guardar y Continuar" UseBrowserDefaults="False" Width="210px" ImageTextSpacing="4">
