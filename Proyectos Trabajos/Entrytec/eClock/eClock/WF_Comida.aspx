<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_Comida.aspx.cs" Inherits="WF_Comida" %>
    ...
    <table id="wrapper" cellspacing="0" border="0">
        <tr style="height: 1px;">
            <td colspan="4" rowspan="1" align="left">
                <ignav:UltraWebMenu ID="Menu" runat="server" EnableAppStyling="True" OnMenuItemChecked="Menu_MenuItemChecked"
                    ...
                    ItemPaddingSubMenus="0" Height="100%" TargetUrl="">
                    <Images>
                    ...
                    <Items>
                        ...
                        <ignav:Item TagString="C_EMPLEADO" Text="Comida por Empleado" 
                            ToolTip="Reporte de Comida por Empleado" CheckBox="True" Checked="True">
                        </ignav:Item>
                        <ignav:Item TagString="D_COMIDA" Text="Detalle Comida" 
                            ToolTip="Muestra el detalle por comida" CheckBox="True">
                        </ignav:Item>
                        <ignav:Item TagString="EMPRESA" Text="Empresa" 
                            ToolTip="Muestra el detalle por Empresa" CheckBox="True">
                        </ignav:Item>
                        <ignav:Item TagString="CENTRO_COSTOS" Text="Centro de Costos" 
                            ToolTip="Muestra el detalle por Centro de Costos" CheckBox="True">
                        </ignav:Item>  
                        <ignav:Item TagString="CARGA_COMIDA" Text="Carga Manual de Comidas" 
                            ToolTip="Muestra el Reporte Personalizado" CheckBox="True">
                        </ignav:Item>
                        <ignav:Item TagString="CARGA_DESAYUNO" Text="Carga Manual de Desayunos" 
                            ToolTip="Muestra el Reporte Personalizado" CheckBox="True">
                        </ignav:Item>
        ...
        <tr style="height: 1px; width: 78px;">
            ...
            <td style="height: 1px; width: 7800px;">
                <table cellspacing="2" style="width: 100%; height: 83px;">
                    <tr>
        ...
        <tr>
            <td colspan="4" rowspan="1" id="TD_Grid" 
                style="vertical-align: top; text-align: left" class="style5">
        ...
        <tr>
            <td colspan="4" rowspan="1" style="text-align: center" class="style3">
                &nbsp;</td>
        </tr>
    </table>
