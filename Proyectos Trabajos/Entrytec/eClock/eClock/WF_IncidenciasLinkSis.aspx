<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WF_IncidenciasLinkSis.aspx.cs" Inherits="WF_IncidenciasLinkSis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
			<table id="Table1" style="WIDTH: 100%; FONT-FAMILY: Arial;" cellpadding="1" width="300" border="0">
				<tr>
...
<BorderDetails ColorLeft="White" ColorTop="White" WidthLeft="1px" WidthTop="1px"></BorderDetails>
				...
				<tr>
					<td style="HEIGHT: 0%" align="center"><igtxt:WebImageButton ID="btn_Regresar" runat="server" Height="22px" Text="Regresar"
                        ...
                        &nbsp;
                        <igtxt:WebImageButton ID="btn_Guardar" runat="server" Height="22px" Text="Guadar"
