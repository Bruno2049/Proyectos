...
<%@ Page language="c#" MasterPageFile="~/MasterPage.master" CodeFile="WF_Tipo_Inc_Sis.aspx.cs" AutoEventWireup="True" Inherits="eClock.WF_Tipo_Inc_Sis" %>
			...
			<TABLE id="Table1" style="WIDTH: 100%; FONT-FAMILY: Arial; HEIGHT: 100%" cellSpacing="1"
				...
				<TR>
					<TD style="HEIGHT: 400px" align="center">
						<igtbl:ultrawebgrid id=Grid runat="server" DataMember="EC_TIPO_INC_SIS" DataSource="<%# dS_TiposIncidencias1 %>" Height="100%" Width="100%" UseAccessibleHeader="False" ImageDirectory="/ig_common/Images/">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
							...
							<Bands>
								<igtbl:UltraGridBand AddButtonCaption="EC_TIPO_INC_SIS" BaseTableName="EC_TIPO_INC_SIS" Key="EC_TIPO_INC_SIS"
									DataKeyField="TIPO_INC_SIS_ID">
									<Columns>
										<igtbl:UltraGridColumn HeaderText="TIPO_INC_SIS_ABR" Key="TIPO_INC_SIS_ABR" IsBound="True" Hidden="True"
											...
											<Header Caption="TIPO_INC_SIS_ABR"></Header>
										</igtbl:UltraGridColumn>
										<igtbl:UltraGridColumn HeaderText="Nombre de la Incidencia" Key="TIPO_INC_SIS_NOMBRE" IsBound="True" BaseColumnName="TIPO_INC_SIS_NOMBRE">
											<Footer>
										...
										<igtbl:UltraGridColumn HeaderText="TIPO_INC_SIS_ID" Key="TIPO_INC_SIS_ID" IsBound="True" Hidden="True"
											...
											<Header Caption="TIPO_INC_SIS_ID">
												<RowLayoutColumnInfo OriginX="2"></RowLayoutColumnInfo>
											</Header>
										</igtbl:UltraGridColumn>
									</Columns>
