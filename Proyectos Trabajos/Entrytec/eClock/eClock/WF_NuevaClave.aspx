...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_NuevaClave.aspx.cs" Inherits="WF_NuevaClave" MasterPageFile="MasterPage3.master" %>
    ...
    <table style="width:100%;">
            ...
            <td colspan="2" style="text-align: left">
                <div class="C03_DarkDenim_TitleLine">
                    <div class="C03_Denim_DarkTitle">
                        <span id="dnn_ctr_dnnTITLE_lblTitle" class="style1">Recuperar Contraseña</span>
                    </div>
                </div>
                <br />
                Puede solicitar su 
                contraseña utilizando su Nombre de usuario y la contraseña le será enviada al 
                correo electrónico utilizado durante el registro.
                <br />
                </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td style="text-align: left">
                <igtxt:WebTextEdit ID="Tbx_Usuario" runat="server" BorderColor="#9FB672" 
