...
{
    public CeC_TiposNomina(CeC_Sesion Sesion):base("EC_TIPO_NOMINA","TIPO_NOMINA_ID",Sesion)
	{
        
	}
    public static int ObtenTipoNominaIDDeTipoNominaIDEx(string TIPO_NOMINA_IDEX, int SuscripcionID)
    {
        return CeC_BD.EjecutaEscalarInt("SELECT TIPO_NOMINA_ID FROM EC_TIPO_NOMINA WHERE TIPO_NOMINA_IDEX = '" + TIPO_NOMINA_IDEX + "' AND "+
