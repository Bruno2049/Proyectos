...
public class CeC_Terminales_Param
{
    ...
    {
        get { return CeC_BD.ObtenParamTerminal(TERMINAL_ID, "SITIO_HIJO_ID", 0); }
    ...
    {
        get { return Convert.ToBoolean(CeC_BD.ObtenParamTerminal(TERMINAL_ID, "TERMINAL_ESENTRADA", 0)); }
    ...
    {
        get { return Convert.ToBoolean(CeC_BD.ObtenParamTerminal(TERMINAL_ID, "TERMINAL_ESSALIDA", 0)); }
    ...
    {
        get { return Convert.ToBoolean(CeC_BD.ObtenParamTerminal(TERMINAL_ID, "TERMINAL_ACEPTA_TA", 0)); }
