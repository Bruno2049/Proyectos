<%@ Page language="c#" CodeFile="WF_UsuariosE.aspx.cs" AutoEventWireup="True" Inherits="eClock.WFEUsuarios" %>
...
<body style="font-size: 11px; font-family: tahoma; text-align: center; margin: 0px; ">
    ...
    cellSpacing=2 cellPadding=1 align=left border=0>
                                    <TBODY>
                                        <TR>
                                            ...
                                            <TD style="WIDTH: 166px" align=left>
                                                <igcmbo:webcombo id="PerfilId" runat="server" BorderColor="Silver" 
                ...
                SelBackColor="DarkBlue" SelForeColor="White">
                                        ...
                                        <TR>
                                            <TD style="WIDTH: 124px; " align=left class="style2">
                                                Usuario</TD>
                                            <TD style="WIDTH: 166px" align=left>
                                                <igtxt:webtextedit id="UsuarioUsuario" runat="server" BorderColor="#7F9DB9" 
                    ...
                    ControlToValidate="UsuarioUsuario" CssClass="style7"></asp:requiredfieldvalidator>
                                            </TD>
                                        </TR>
                                        <TR style="COLOR: #000000">
                                            <TD style="WIDTH: 124px; " align=left class="style2">
                                                Nombre</TD>
                                            <TD style="WIDTH: 166px" align=left>
                                                <igtxt:webtextedit id="UsuarioNombre" runat="server" BorderColor="#7F9DB9" 
                    Font-Names="Arial Narrow" BorderWidth="1px" BorderStyle="Solid" Width="200px" 
                    UseBrowserDefaults="False" CellSpacing="1">
                                                    <ButtonsAppearance CustomButtonDefaultTriangleImages="Arrow">
                                                        <ButtonPressedStyle BackColor="#83A6F4">
                    ...
                    ControlToValidate="UsuarioNombre" CssClass="style7"></asp:requiredfieldvalidator>
                                            </TD>
                                        </TR>
                                        <TR>
                                            <TD align=left class="style3">
                                                Descripción&nbsp;</TD>
                                            <TD style="WIDTH: 166px" align=left>
                                                <igtxt:webtextedit id="UsuarioDescripcion" runat="server" BorderColor="#7F9DB9" 
                    Font-Names="Arial Narrow" BorderWidth="1px" BorderStyle="Solid" Width="200px" 
                    UseBrowserDefaults="False" CellSpacing="1">
                                                    <ButtonsAppearance CustomButtonDefaultTriangleImages="Arrow">
                                                        <ButtonPressedStyle BackColor="#83A6F4">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="width: 166px">
                                                <igtxt:webtextedit id="txtCorreo" runat="server" BorderColor="#7F9DB9" 
                Font-Names="Arial Narrow" BorderWidth="1px" BorderStyle="Solid" Width="200px" 
                UseBrowserDefaults="False" CellSpacing="1">
                                                    <ButtonsAppearance CustomButtonDefaultTriangleImages="Arrow">
                                                        <ButtonStyle Width="13px" BorderWidth="1px" BorderColor="#ABC1F4" BorderStyle="Solid" ForeColor="#506080"
                ...
                align=left class="style2">
                                                Usuario Clave</TD>
                                            <TD style="WIDTH: 166px; " align=left>
                                                <igtxt:webtextedit id="UsuarioClave" runat="server" BorderColor="#7F9DB9" 
                    Font-Names="Arial Narrow" BorderWidth="1px" BorderStyle="Solid" Width="200px" 
                    UseBrowserDefaults="False" CellSpacing="1" PasswordMode="True">
                                            ...
                                            <TD align=left>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                    ControlToValidate="UsuarioClave" CssClass="style7" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" style="WIDTH: 166px; HEIGHT: 26px">
                                                <igtxt:WebTextEdit ID="UsuarioClaveC" runat="server" BorderColor="#7F9DB9" 
                                            ...
                                            <td align="left" style="HEIGHT: 26px">
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                                    ControlToCompare="UsuarioClaveC" ControlToValidate="UsuarioClave" 
                                                    CssClass="style7" 
                                        ...
                                        <TR>
                                            ...
                                            <TD style="WIDTH: 166px; height: 26px;" align=left>
                                                <igcmbo:WebCombo ID="Cbx_Agrupacion" runat="server" BackColor="White" 
