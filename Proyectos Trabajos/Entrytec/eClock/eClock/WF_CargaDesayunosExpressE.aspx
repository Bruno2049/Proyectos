<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_CargaDesayunosExpressE.aspx.cs" Inherits="WF_CargaDesayunosExpressE" %>
...
<body>
    ...
    <igmisc:webpanel ID="Wpn_CARGA_COMIDAS_" runat="server" BackColor="White" BorderColor="SteelBlue"
            ...
            Width="772px">
                            ...
                            <Header TextAlignment="Left" Text="Carga Manual de Desayunos">
                            </Header>
        <template>
        <table class="style1">
        <tr>
        ...
        <tr>
            <td class="style4">
                <igtxt:WebImageButton ID="BGuardarCambios" runat="server" Height="22px" OnClick="BGuardarCambiosM_Click"
                    ...
                    ImageTextSpacing="4" style="text-align: center">
            ...
            <td style="text-align: center">
                <igtxt:WebImageButton ID="Webimagebutton1" runat="server" Height="22px" 
                    ImageTextSpacing="4" OnClick="BGuardarCambios_Click" Text="Guardar y Continuar" 
                    UseBrowserDefaults="False" Width="210px">
                    <Alignments VerticalAll="Bottom" VerticalImage="Middle" />
                    <Appearance>
                        <Image Height="16px" Url="./Imagenes/Next.png" Width="16px" />
                        <style cursor="Default">
                        </style>
                    </Appearance>
