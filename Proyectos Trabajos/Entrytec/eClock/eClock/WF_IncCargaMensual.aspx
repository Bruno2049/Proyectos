<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WF_IncCargaMensual.aspx.cs" Inherits="WF_IncidenciasCargaMasiva" %>
...
<body>
    ...
    <igmisc:WebPanel ID="Wpn_AGREGAR_INCIDENCIAS_" runat="server" BackColor="White" BorderColor="SteelBlue"
        ...
        <asp:TableCell>
            ...
            <br />
            <br />
            <asp:Label ID="Lbl_Ano" runat="server" Text="Año"></asp:Label><asp:TextBox ID="Tbx_Ano" runat="server" Width="44px"></asp:TextBox>
            <asp:Label ID="Lbl_Mes" runat="server" Text="Mes"></asp:Label><asp:TextBox ID="Tbx_Mes" runat="server" Width="44px"></asp:TextBox>
