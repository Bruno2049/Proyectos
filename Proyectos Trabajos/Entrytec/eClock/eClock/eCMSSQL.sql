...
CREATE TABLE EC_TERMINALES_TIPO_FALLA (
  TERMINAL_TIPO_FALLA_ID INTEGER  NOT NULL   IDENTITY ,
...
CREATE TABLE EC_SUSCRIP_DATOS (
  SUSCRIP_DATOS_RAZON VARCHAR(255)     IDENTITY ,
...
CREATE TABLE EC_TIPO_INCIDENCIAS_EX (
  ...
  TIPO_FALTA_EX_ID INTEGER  NOT NULL DEFAULT 0 ,
...
CREATE TABLE EC_TAREAS (
  TAREA_ID INTEGER  NOT NULL   IDENTITY ,
  TIMESPAN_ID INTEGER  NOT NULL  ,
...
CREATE TABLE EC_TURNOS (
  ...
  TIPO_TURNO_ID INTEGER  NOT NULL DEFAULT 0 ,
...
CREATE TABLE EC_SUSCRIPCION (
  ...
  SUSCRIP_PRECIO_ID INTEGER  NOT NULL   IDENTITY ,
...
CREATE TABLE EC_ENV_REPORTES (
  ...
  FORMATO_REP_ID INTEGER  NOT NULL DEFAULT 0 ,
  REPORTE_ID INTEGER  NOT NULL  ,
...
CREATE TABLE EC_PERSONAS_D_HE (
  ...
  TIPO_INCIDENCIA_ID INTEGER  NOT NULL DEFAULT 0 ,
  SESION_ID INTEGER  NOT NULL  ,
...
CREATE TABLE EC_LOG_AUDITORIA (
  ...
  TIPO_AUDITORIA_ID INTEGER  NOT NULL DEFAULT 0 ,
...
CREATE TABLE EC_MONEDERO (
  ...
  TIPO_COBRO_ID INTEGER  NOT NULL DEFAULT 0 ,
  PERSONA_ID INTEGER  NOT NULL  ,
  SESION_ID INTEGER  NOT NULL DEFAULT 0 ,
