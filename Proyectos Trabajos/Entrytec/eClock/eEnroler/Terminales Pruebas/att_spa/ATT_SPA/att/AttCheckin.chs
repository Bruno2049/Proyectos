...
FormAttMain.mnuReport.caption=考勤异常查询与报表
...
FormEmployeelist.Label16.Caption=权限
...
FormEmployeelist.GroupBox5.Caption=照片(1:1.5)
...
FormAttRec.ChkInOut.DisplayLabel[5]=签到/退
...
FrameDeptAndEmps1.lcbName.Hint=直接输号码、姓名或拼音、拼音首字母可以查询员工
...
fUsbSelect.rb9Code.Caption=9位码(定制)
fUsbSelect.rb24Code.Caption=自助式指纹打卡钟(参见指纹机启动界面)
