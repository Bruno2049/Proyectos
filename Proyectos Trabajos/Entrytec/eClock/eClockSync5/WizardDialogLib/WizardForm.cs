    ...
    public class WizardForm : Form
    {
        ...
        private void ApplyResources(Control parent, CultureInfo culture)
        {
            ...
            foreach (Control ctl in parent.Controls)
            {
                ...
                try
                {
                    if (ctl.GetType().BaseType == WP.GetType() || ctl.GetType().BaseType.BaseType == WP.GetType())
                        ((WizardPage)ctl).Culture = culture;
                }
                catch { }
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            // m_separator
            // 
            this.m_separator.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)
