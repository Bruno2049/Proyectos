...
namespace SMS.Windows.Forms
{
    ...
    "ard by clarifying the task in some way.";
            ...
            this.m_headerPicture.Image = global::SMS.Windows.Forms.Properties.Resources.header;
            ...
            this.Load += new System.EventHandler(this.InteriorWizardPage_Load);
        ...
        private void InteriorWizardPage_Load(object sender, EventArgs e)
        {
