...
namespace Universidad.Controlador.SVR_Login {
    ...
    public interface IS_Login {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IS_Login/ObtenPersonas", ReplyAction="http://tempuri.org/IS_Login/ObtenPersonasResponse")]
        System.IAsyncResult BeginObtenPersonas(Universidad.Entidades.US_USUARIOS usuario, System.AsyncCallback callback, object asyncState);
        
        Universidad.Entidades.PER_PERSONAS EndObtenPersonas(System.IAsyncResult result);
    }
    ...
    public partial class ObtenPersonasCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public ObtenPersonasCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    public partial class S_LoginClient : System.ServiceModel.ClientBase<Universidad.Controlador.SVR_Login.IS_Login>, Universidad.Controlador.SVR_Login.IS_Login {
        ...
        private BeginOperationDelegate onBeginObtenPersonasDelegate;
        
        private EndOperationDelegate onEndObtenPersonasDelegate;
        
        private System.Threading.SendOrPostCallback onObtenPersonasCompletedDelegate;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginObtenPersonas(Universidad.Entidades.US_USUARIOS usuario, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginObtenPersonas(usuario, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public Universidad.Entidades.PER_PERSONAS EndObtenPersonas(System.IAsyncResult result) {
            return base.Channel.EndObtenPersonas(result);
        }
        
        private System.IAsyncResult OnBeginObtenPersonas(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Universidad.Entidades.US_USUARIOS usuario = ((Universidad.Entidades.US_USUARIOS)(inValues[0]));
            return this.BeginObtenPersonas(usuario, callback, asyncState);
        }
        
        private object[] OnEndObtenPersonas(System.IAsyncResult result) {
            Universidad.Entidades.PER_PERSONAS retVal = this.EndObtenPersonas(result);
            return new object[] {
                    retVal};
        }
        
        private void OnObtenPersonasCompleted(object state) {
            if ((this.ObtenPersonasCompleted != null)) {
                InvokeAsyncCompletedEventArgs e = ((InvokeAsyncCompletedEventArgs)(state));
                this.ObtenPersonasCompleted(this, new ObtenPersonasCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState));
            }
        }
        
        public void ObtenPersonasAsync(Universidad.Entidades.US_USUARIOS usuario) {
            this.ObtenPersonasAsync(usuario, null);
        }
        
        public void ObtenPersonasAsync(Universidad.Entidades.US_USUARIOS usuario, object userState) {
            if ((this.onBeginObtenPersonasDelegate == null)) {
                this.onBeginObtenPersonasDelegate = new BeginOperationDelegate(this.OnBeginObtenPersonas);
            }
            if ((this.onEndObtenPersonasDelegate == null)) {
                this.onEndObtenPersonasDelegate = new EndOperationDelegate(this.OnEndObtenPersonas);
            }
            if ((this.onObtenPersonasCompletedDelegate == null)) {
                this.onObtenPersonasCompletedDelegate = new System.Threading.SendOrPostCallback(this.OnObtenPersonasCompleted);
            }
            base.InvokeAsync(this.onBeginObtenPersonasDelegate, new object[] {
                        usuario}, this.onEndObtenPersonasDelegate, this.onObtenPersonasCompletedDelegate, userState);
        }
    }
}
