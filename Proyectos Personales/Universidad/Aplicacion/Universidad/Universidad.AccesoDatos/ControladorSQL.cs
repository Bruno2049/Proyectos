...
namespace Universidad.AccesoDatos
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// <returns></returns>
        public static int ExecuteNonQueryGetID(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteNonQueryGetID(connection, commandType, commandText, commandParameters);
            }
        }
        ...
        /// <param name="commandParameters"></param>
        /// <returns></returns>
        public static int ExecuteNonQueryGetID(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        public static DataTable ExecuteDataTable(string SqlConnectionString, CommandType commandType, string commandText)
        {
            // Pass through the call providing null for the set of SqlParameters
            return ExecuteDataTable(SqlConnectionString, commandType, commandText, (SqlParameter[])null);
        }
        ...
        public static DataTable ExecuteDataTable(string SqlConnectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(SqlConnectionString))
                {
                    ...
                    // Call the overload that takes a connection in place of the connection string
                    DataTable dt = ExecuteDataTable(connection, commandType, commandText, commandParameters);
                    return dt;
                }
            }
            catch (SqlException ex)
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        public static DataTable ExecuteDataTable(string SqlConnectionString, string spName, params object[] parameterValues)
        {
            if (SqlConnectionString == null || SqlConnectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                // Call the overload that takes an array of SqlParameters
                return ExecuteDataTable(SqlConnectionString, CommandType.StoredProcedure, spName, commandParameters);
            }
            else
            {
                // Otherwise we can just call the SP without parameters
                return ExecuteDataTable(SqlConnectionString, CommandType.StoredProcedure, spName);
            }
        }
